---
sidebar_position: 2
title: AOT Twin  Builder Plant Layout Tutorial
---
...
![Plant Layout tab showing the selected model](./media/AOT_Twin%20_Builder_Plant_Layout_Tutorial/image3.png)

On the grid, click on a model to open the edit menu. The menu opens at the left side of the screen and enables navigation to various features which are described in the table below. Click the video link below for a brief demo.
...
| Close Menu | This option is used to close the menu. ![Thumbnail image for Manipulate Models Video](./media/AOT_Twin%20_Builder_Plant_Layout_Tutorial/image5.png)
[]\{#_Toc218772049 .anchor\} [VIDEO LINK](https://greetings.accenture.com/watch/btsnM8gEMqxHH1YffKqEPq) |

## Save Layout

Use the *Save* button located in the top right corner to save the newly created layout.

![Plant Layout page showing the Save option](./media/AOT_Twin%20_Builder_Plant_Layout_Tutorial/image6.png)
...
![UI showing the Generate Layout side menu bar and the grid](./media/AOT_Twin%20_Builder_Plant_Layout_Tutorial/image7.png)
...
| D | move left |
| W | move forward |
| S | move backward [VIDEO LINK](https://greetings.accenture.com/watch/qMwkAXXjZx2MbpyxoV9oNx) ![Thumbnail image for Move Camera video](./media/AOT_Twin%20_Builder_Plant_Layout_Tutorial/image10.png)
|  |
