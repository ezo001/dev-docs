---
sidebar_position: 2
title: AOT Extractors Getting Started
---
...
| 3 | AOT delivery team ensures environment readiness with all prerequisites / resources |
| 4 | AOT delivery team establishes and validates internal connections between Pipeline and environment |
| 5 | AOT delivery team establishes and validates connection between extractors and source system |
| 6 | AOT delivery team tests connection between source to connector to RAW |
| 7 | AOT delivery team configures the extractor parameters such as frequency and data specifics |
| 8 | AOT delivery team deploys the extractor |
| 9 | AOT delivery team configures and schedules transformation logic in CDF |
