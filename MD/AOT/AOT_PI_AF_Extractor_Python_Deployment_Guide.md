---
sidebar_position: 2
title: AOT PI AF Extractor Python Deployment Guide
---
...
| **Related Assets / Alternatives** | AOT Extractors Architecture Blueprint, AOT Extractors Getting Started ![](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image1.png)
|  |
...
| PIPassword | Provide the password for OSI PI Server &gt; ![Screenshot of Create a secret dialog window](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image3.png)
|  |
| - | Create a key vault library in Azure DevOps and add the secrets created in the previous step. &gt; ![Screenshot of key vault library in Azure DevOps and added secrets created in the previous step.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image4.png)
|  |
...
| PIAF_CLI_PROJECT_NAME | Provide SonarQube project name for PI AF extractor. &gt; ![Screenshot of variable group library AOT-CommonServices-Extractor-dev](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image5.png)
|  |
| - | Navigate to the pipeline file location \"Source/Extractors/PIAF-extractor-2.0/pipeline/Dev/azure-pipelines.yml\" and ensure that the pipeline is referring to the libraries created in the previous steps. &gt; ![Screenshot showing the pipeline file location](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image6.png)
|  |
| - | Configure the following parameters in the configuration file for the PIAF Extractor: |
| - | Provide timer value in seconds to schedule the extractor. &gt; ![screenshot depicting the timer value provided in seconds](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image7.png)
|  |
...
| idp-authentication. tenant | Use the tenant Id for CDF added in the Azure DevOps library in earlier steps &gt; ![Screenshot of the Cognite related config parameters](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image8.png)
|  |
...
| assets.category_name | OPTIONAL - Provide category name from OSI PI Server to filter child elements in the asset hierarchy. &gt; ![Screenshot of OSI PI related config parameters](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image9.png)
|  |
...
> ![Screenshot showing the New Pipeline option in Azure DevOps](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image11.png)
-   Select **Azure Repos Git**. Then select the Repository Name that contains the PI AF Extractor code and pipeline files.

> ![Screenshot of Azure DevOps showing the option Azure Repos Git](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image12.png)

-   Select \'Existing Azure Pipelines YAML file\'.

> ![Screenshot of Azure DevOps showing the option \'Existing Azure Pipelines YAML file\'](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image13.png)
...
> ![Screenshot that shows configuring the pipeline and the dialog window to select an existing YAML file.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image14.png)
-   Review and save.
...
> ![Screenshot showing the updated value of service connection for AKS cluster in the tasks](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image15.png)
-   Update the AKS file location in the tasks.

> ![Screenshot showing how the AKS file location is updated in the tasks](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image16.png)

-   If this is the first run, then disable the delete task from the pipeline. 

> ![Screenshot showing the disabling of the delete task from the pipeline](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image17.png)
-   Create a release from the release pipeline created in the previous step. 

> ![Screenshot showing the option \'Create Release\'](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image18.png)
-   Once the release is completed, confirm that the deployment is successful on Azure DevOps.

> ![Screenshot showing the successful deployment on Azure DevOps](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image19.png)
-   After deployment is complete, check the Azure Portal to validate that the deployment to the AKS cluster was successful.

> ![Screenshot showing the successful validation of deployment to AKS cluster in Azure portal](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image20.png)
...
> ![Screenshot of Lens app showing the logs](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image21.png)

-   If everything looks good and the AKS POD is created, enable the delete task that was previously disabled.

> ![Screenshot showing the options to enable the delete task that was previously disabled.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image22.png)
-   Validate the creation of the database and table with asset hierarchy data on the CDF Portal.

> ![Screenshot of validating the creation of database and table with asset hierarchy data on Cognite Data Fusion Portal.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image23.png)
...
> ![Success message displayed in CDF after deployment is complete successfully](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image24.png)
## 
...
> ![Screenshot showing the added path of a log file to store extractor logs.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image25.png)
-   Add timer value in seconds to schedule the extractor.

> ![Screenshot showing the added timer value in seconds to schedule the extractor.](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image7.png)
...
| - | pythonXX.dll |
| - | pythoncomXX.dll |
| - | pywintypesXX.dll &gt; ![Screenshot of the libraries installed in the system](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image27.png)
|  |
...
> ![Screenshot of Services app in Start menu showing the option to run as adminstrator](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image28.png)
-   Search for the \"PIAFExtractor\" service name, right-click on it, and select **Start**.

> ![Screenshot showing the PIAF Extractor and the option to Start the service](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image29.png)
...
> ![Screenshot of CDF portal where the database and tables with asset hierarchy data are created](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image23.png)
-   Validate the creation of the extraction pipeline with a success message on the CDF portal.

> ![Success message shown on CDF portal](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image24.png)
### 
...
> ![Screenshot showing the Services App in Start menu and the option to run as adminstrator](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image28.png)
-   Search for the \"PIAFExtractor\" service name, right-click on it, and select **Stop**.

> ![Screenshot showing the PIAF Extractor service and the option to Stop](./media/AOT_PI_AF_Extractor_Python_Deployment_Guide/image30.png)
