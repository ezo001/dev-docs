---
sidebar_position: 2
title: AOT People Management Architecture Blueprint
---
...
![Mappings with respect to People Management](./media/AOT_People_Management_Architecture_Blueprint/image2.png)
...
![Diagram depicting the cache mappings](./media/AOT_People_Management_Architecture_Blueprint/image3.png)
...
![functional permissions for PM with AOT components](./media/AOT_People_Management_Architecture_Blueprint/image4.png)
...
![data permissions for PM with AOT components](./media/AOT_People_Management_Architecture_Blueprint/image5.png)

## Integration

People management can be integrated with other AOT components to add restrictions based on Role and/or department.

![Diagrammatic view of People Management integration with other AOT components](./media/AOT_People_Management_Architecture_Blueprint/image6.png)
...
![Relation of KPIs and Insights with Role, Department and Asset Hierarchy](./media/AOT_People_Management_Architecture_Blueprint/image7.png)
