---
sidebar_position: 2
title: AOT Intelligent Advisor Configuration UI Guide
---
...
| **Related Assets / Alternatives** | Intelligent Advisor UI Guide, Intelligent Advisor Delivery Guide ![](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image2.png)
|  |
...
![Intelligent Advisor tile](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image3.png)

4.  Select *Intelligent Advisor* from the listed components to launch the IA Configuration landing page.

![Component configuration menu showing the Intelligent Advisor option](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image4.png)
...
| 7 | Digital Twin Assistant -- When deployed in Azure, clicking the robot icon launches a generative AI based assistant. ![IA Configuration Landing Page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image5.png)
|  |
...
![delete configuration](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image6.png)

![Delete Configuration message](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image7.png)
...
![Configure Insights dropdown that displays 3 options: Custom, Insights based on KPIs, and Predictive Failure Configuration](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image8.jpeg)
...
![Configure KPI Insights page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image9.png)
...
![KPI SELECTION screen](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image10.png)
...
| 4 | SUBMIT CONFIGURATION -- Disabled unless all configured KPIs have been removed. ![Configure KPI Insights - KPI selection page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image11.png)
|  |
...
![Edit KPI option](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image12.png)
...
| 3 | SAVE CONFIGURATION -- This option saves the configuration. It remains disabled if the user does not make any changes. ![A screenshot of a computer](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image13.png)
|  |
...
![Screenshot showing the algorithm option](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image14.png)

![Screenshot showing the algorithm option when completed](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image14.png)
...
![Configure Predictive Failure page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image15.png)
...
![Asset selection page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image16.png)
...
![Asset selection page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image17.png)
...
![configuration options video thumbnail](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image18.png)
...
![AOT_IA_Config_2](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image19.jpeg)
...
![Configure Predictive Failure: Asset selection page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image20.png)
...
![Image showing the Edit option on the selected row of the Predictive failure configuration](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image21.png)

The following image depicts the Configuration screen. The dropdowns are already populated with the previously saved data.

![Edit configuration page that allows the user to edit previously saved data for the configuration](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image22.png)

Clicking the NEXT STEP button allows the addition or removal of Impacted KPIs. Adding Impacted KPIs is optional.

![configure predictive failure- impacted KPIs page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image23.png)
...
![Configure custom insight category page showing the algorithm feature](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image24.png)
...
| 3\. | NEXT STEP \- Clicking advances to Step 2. |
| 4\. | ASSET TABLE \- Shows selected assets. |
| 5\. | DELETE \- Clicking removes the selected asset from the table. ![Configure Custom Insight Category window showing Asset selection page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image25.png)
The *ASSET SELECTION* pop-up window has the following controls: 1. CLOSE\ - Closes the popup without saving the selected Assets. SELECT ASSETS\ - List of Assets with checkboxes. Users can select/deselect multiple Assets. Configured Assets are grayed out and cannot be selected. The Assets are based on the selected Plant. SELECT\ - Shows the number of selected assets and saves the selection to be displayed on the Selected Assets table. ![Asset selection page expanded with check boxes for assets](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image26.png)
|  |
...
![Configure Custom Insight Category window showing Configuration page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image27.png)
...
![Configure Custom Insight Category window showing Impacted KPIs page](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image28.png)
...
![Configure Custom Insight Category window showing Asset selection page with option to delete selected asset](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image29.png)
...
![Option to edit configuration](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image30.png)

The following image depicts the Configuration screen. The dropdowns are already populated with the previously saved data.

![Configure Custom Insight Category window showing the option to Edit the Configuration ](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image31.png)

Clicking on the *NEXT STEP* button allows the addition or removal of Impacted KPIs.

![Edit Configurations page showing the Impacted KPIs to edit/select](./media/AOT_Intelligent_Advisor_Configuration_UI_Guide/image32.png)
