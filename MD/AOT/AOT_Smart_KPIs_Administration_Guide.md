---
sidebar_position: 2
title: AOT Smart KPIs Administration Guide
---
...
![Diagram showing the process of creatin and configuring a template.](./media/AOT_Smart_KPIs_Administration_Guide/image3.png)
...
3.  Click *Ok*.\
    ![Menu that comes up after right-clicking on the sheet tab. The option \"Unhide\" is highlighted.](./media/AOT_Smart_KPIs_Administration_Guide/image4.png)
...
> ![Image is of the top header row of the template sheet with the column: Plant, Unit, System, Sub-System. Components, and NA depicted.](./media/AOT_Smart_KPIs_Administration_Guide/image5.png)
...
> ![Screenshot of the Data Validation dialog window with mentioned fields highlighted](./media/AOT_Smart_KPIs_Administration_Guide/image6.png)
...
> ![Security warning shown in Excel Sheet with the Enable Content button.](./media/AOT_Smart_KPIs_Administration_Guide/image7.png)
...
![A screenshot of Upload KPI pop-up that shows \"Upload KPI\" option and \"Continue\" button.](./media/AOT_Smart_KPIs_Administration_Guide/image9.png)

Figure 3

![Screenshot showing the successful upload of the filled KPI template](./media/AOT_Smart_KPIs_Administration_Guide/image10.png)

Figure 4

![Screenshot of the Upload KPI pop-up window that shows the DONE button as inactive since the uploaded file is being processed.](./media/AOT_Smart_KPIs_Administration_Guide/image11.png)

Figure 5

![Upload KPI pop-up window showing the upload files.](./media/AOT_Smart_KPIs_Administration_Guide/image12.png)
...
![Screenshot of the dashboard with all the KPI tiles and trendlines visible](./media/AOT_Smart_KPIs_Administration_Guide/image13.png)
...
![Screenshot of one of the error scenarios when the archiving is not done properly](./media/AOT_Smart_KPIs_Administration_Guide/image14.png)
...
![Screenshots showing Smart KPIs option as disabled, when the user does not have the 'Admin_SmartKPI' role](./media/AOT_Smart_KPIs_Administration_Guide/image15.png)

![Screenshots showing Smart KPIs option as disabled, when the user does not have the 'Admin_SmartKPI' role](./media/AOT_Smart_KPIs_Administration_Guide/image16.png)
...
![Screenshot of the error page, when an user without Smart KPIs config access, tries to hit the Config URL directly on the browser. ](./media/AOT_Smart_KPIs_Administration_Guide/image17.png)
