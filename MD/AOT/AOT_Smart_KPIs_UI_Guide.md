...
> ![Dashboard of the Smart KPIs application in AOT](./media/AOT_Smart_KPIs_UI_Guide/image2.png)
### 
...
![OT and NON-OT KPIS](./media/AOT_Smart_KPIs_UI_Guide/image4.png)
...
> ![A screenshot of sorted KPIs](./media/AOT_Smart_KPIs_UI_Guide/image5.png)
...
![Trend timeline with the tooltip message that displays complete details](./media/AOT_Smart_KPIs_UI_Guide/image6.png)
...
![KPI comparison in Trend Timeline](./media/AOT_Smart_KPIs_UI_Guide/image7.png)
...
> ![KPI Tile](./media/AOT_Smart_KPIs_UI_Guide/image8.png)
### 
...
***\
***![screenshot of parent kpi with calculation frequency of two hours](./media/AOT_Smart_KPIs_UI_Guide/image9.png)
...
![Screenshot that shows the result of different calculation frequencies between the Parent and Contributing KPIs](./media/AOT_Smart_KPIs_UI_Guide/image10.png)
...
![aggregated data of the parameter in which the parent KPI is being calculated despite the calculation frequency difference.](./media/AOT_Smart_KPIs_UI_Guide/image11.png)
...
![Errored KPI Tile](./media/AOT_Smart_KPIs_UI_Guide/image12.png)
...
[\
VIDEO LINK](https://greetings.accenture.com/watch/tL41t9bxFNbXVfHjzqXzaK)

![Video thumbnail for the calendar and KPI tiles video ](./media/AOT_Smart_KPIs_UI_Guide/image13.png)
...
[\
VIDEO LINK](https://greetings.accenture.com/watch/VfeADvQqvv5MkMgnSr6ivD)

![Video thumbnail for KPI drilldown details functionality](./media/AOT_Smart_KPIs_UI_Guide/image14.png)
...
> ![KPI tiles with tooltip messages for no further drilldown possible](./media/AOT_Smart_KPIs_UI_Guide/image15.png)
### 
...
![KPI and Parameter tile comparison](./media/AOT_Smart_KPIs_UI_Guide/image16.png)
...
![Trend timeline for Parameters](./media/AOT_Smart_KPIs_UI_Guide/image17.png)
...
![KPI tile that displays the message \'Further drill down disabled due to access restrictions. Please contact Admin to get the required access.\'](./media/AOT_Smart_KPIs_UI_Guide/image18.png)
...
![Non OT KPI drilldown details](./media/AOT_Smart_KPIs_UI_Guide/image19.png)
...
![Non OT KPI drilldown details](./media/AOT_Smart_KPIs_UI_Guide/image20.png)
...
![Contributing KPIs in tabular view](./media/AOT_Smart_KPIs_UI_Guide/image21.png)

If there is no data available, a message stating \'No Records Found\' will be displayed, as shown in the screenshot below.

![Events table showing \'no records found\' message](./media/AOT_Smart_KPIs_UI_Guide/image22.png)
...
![Batch table](./media/AOT_Smart_KPIs_UI_Guide/image23.png)
...
![Trend timeline](./media/AOT_Smart_KPIs_UI_Guide/image24.png)
...
![Asset downtime bar chart](./media/AOT_Smart_KPIs_UI_Guide/image25.png)

![asset downtime piechart](./media/AOT_Smart_KPIs_UI_Guide/image26.png)
...
![Date picker to select time range to plot trend timeline graphs](./media/AOT_Smart_KPIs_UI_Guide/image27.png)

![Calendar and trend timeline](./media/AOT_Smart_KPIs_UI_Guide/image28.png)
...
![Date picker UI component](./media/AOT_Smart_KPIs_UI_Guide/image29.png)
...
![Hours selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image30.png)
...
![Days selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image31.png)

####  Week Selection

The week picker enables the selection of an entire week at a time.

![ Weeks selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image32.png)

####  Month Selection

The month picker allows the selection of a particular month.

![ Month selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image33.png)
...
![Quarter selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image34.png)

#### Half Year Selection

The half-year picker allows the selection of half a year at a time.

![Half Year selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image35.png)

#### Year Selection

The year picker allows the selection of a year from a range of 16 years ending at the current year.

![Year selection UI component](./media/AOT_Smart_KPIs_UI_Guide/image36.png)
...
![UI component for Custom range selection](./media/AOT_Smart_KPIs_UI_Guide/image37.png)
...
[\
VIDEO LINK](https://greetings.accenture.com/watch/B7d7gyXhzznfg3H2eNdjU6?)

![Thumbnail for video for Pagination and Vertical scrolling.](./media/AOT_Smart_KPIs_UI_Guide/image38.jpeg)
...
![KPI Tile with data before auto-refresh](./media/AOT_Smart_KPIs_UI_Guide/image39.png)

![\"fetching data\" message that displays when data is autorefreshing](./media/AOT_Smart_KPIs_UI_Guide/image40.jpeg)

![KPI tile after auto-refresh](./media/AOT_Smart_KPIs_UI_Guide/image41.png)
...
[\
VIDEO LINK](https://greetings.accenture.com/watch/Lz4MbxEZY795VxBMu42kMJ?)

![Video thumbnail for KPI Details on Intelligent Advisor ](./media/AOT_Smart_KPIs_UI_Guide/image42.png)
...
![OH Integration: KPIs for an asset selected in the Operations Hierarchy pane are displayed in the main pane. ](./media/AOT_Smart_KPIs_UI_Guide/image43.png)
...
> [\
> VIDEO LINK](https://greetings.accenture.com/watch/LreoF2MrYDHDNaeuZmqKQb?)
>
> ![video thumbnail of OH_Integration](./media/AOT_Smart_KPIs_UI_Guide/image44.jpeg)
...
![screenshot of access issue error](./media/AOT_Smart_KPIs_UI_Guide/image45.png)

As shown below, drilling down into an asset that has a configured KPI displays the KPI detail of the selected asset.

![A screenshot that shows drilling down into an asset that has a configured KPI which displays the KPI detail of the selected asset.](./media/AOT_Smart_KPIs_UI_Guide/image46.png)
...
![Digital Twin Assistant panel expanded which prompts to get started](./media/AOT_Smart_KPIs_UI_Guide/image47.png)
