---
sidebar_position: 2
title: AOT Smart KPIs API Reference
---
...
![](./media/AOT_Smart_KPIs_API_Reference/image1.png)
...
| 400 | 401 Unauthorized / \{HeaderToken\} could be missing or expired |
| 400 | 400 Bad request |
| ## | POST- INSIGHT API The INSIGHT API is part of the AOT-SmartKPI-Middleware Microservice that is invoked by the UI and consumed by the UI. Insight API is a POST call to the Smart KPI AOT DEV server is hosted at the backend to get the details of actual, forecast, historical, target, RAGStatus, and CompareActual calculations for a KPI. |
