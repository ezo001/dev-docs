---
sidebar_position: 2
title: AOT AWS CDF Architecture
---
...
![](./media/AOT_AWS_CDF_Architecture/image8.svg)
...
| - | External services (Lambda Functions, Databricks, etc.) See also: [AOT Extractors Architecture Blueprint](https://industryxdevhub.accenture.com/assetdetails/46) |
...
![Diagram mapping Intelligent Advisor's integration with DataOps, Smart KPIs, People Management, Operations Hierarchy, Reporting, 3D Visualizer, and MLOps.](./media/AOT_AWS_CDF_Architecture/image14.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image20.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image22.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image24.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image34.svg)
...
| &gt; ![](./media/AOT_AWS_CDF_Architecture/image36.svg)
|  |
...
![](./media/AOT_AWS_CDF_Architecture/image38.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image46.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image48.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image49.png)
...
![](./media/AOT_AWS_CDF_Architecture/image53.svg)
...
| Localization Configuration Database | Stores UoM configuration. The container diagram below provides insights into how to use the internationalization component across AOT. ![](./media/AOT_AWS_CDF_Architecture/image55.svg)
|  |
...
![](./media/AOT_AWS_CDF_Architecture/image57.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image59.svg)
...
![Diagram showing People Management at the center, managing roles and access for users and groups, with connections to Smart KPIs, Intelligent Advisor, 3D Visualizer, Operations Hierarchy, and Reporting modules.](./media/AOT_AWS_CDF_Architecture/image70.svg)
...
![](./media/AOT_AWS_CDF_Architecture/image74.svg)

\
[Diagram showing communication connections]

![](./media/AOT_AWS_CDF_Architecture/image76.svg)
...
![Diagram showing reporting modules reading data from knowledge graph, Operations Hierarchy, Smart KPIs, Intelligent Advisor, and People Management for permissions.](./media/AOT_AWS_CDF_Architecture/image78.svg)
