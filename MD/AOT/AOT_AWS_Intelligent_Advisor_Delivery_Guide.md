...
![](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image2.png)
...
| - | Minute: Insert a number from 1-60. The below diagram describes Generic Scheduler and CRUD operations (Create, Read, Update, Delete) performed on tasks. ![A computer screen shot of a diagram AI-generated content may be incorrect.](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image3.png)
...
| - | Delete configuration: After the delete configuration request is passed from the UI, the delete configuration API is called. The delete API deletes the data from the configuration database table and calls the Delete Scheduler API, which deletes data from the scheduler database table as well as the scheduler process. Refer to [AOT Generic Scheduler Technical Overview](https://industryxdevhub.accenture.com/assetdetails/83) for more information about the Generic Scheduler Microservice APIs. |
...
![IA config db structure](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image4.png)
...
![](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image5.png)
...
![query for insight category configuration](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image6.png)
...
![query for insight category configuration parameters](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image7.png)
...
![A screenshot of a computer AI-generated content may be incorrect.](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image8.png)
...
![UC1 -- Predicting Control Valve Failure flow diagram](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image9.png)
...
![UC2- smart KPI for OEE flow diagram](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image10.png)
...
![AOT Insight template hierarchy diagram](./media/AOT_AWS_Intelligent_Advisor_Delivery_Guide/image11.png)
