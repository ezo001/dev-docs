---
sidebar_position: 2
title: AOT Simulator IoTHub Extractor Deployment Guide
---
...
## ![](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image2.png)
Introduction
...
> ![Screenshot of Azure DevOps showing the New pipeline option](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image3.png)
2.  Select the Azure Repos Git.

> ![Screenshot of ADO showing the Azure Repos Git option](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image4.png)
3.  Select the name of the repository that contains the simulator code and pipeline files.

> ![Screenshot showing the option to select a repository](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image5.png)
4.  

5.  Select the Existing Azure Pipelines YAML file.

> ![Screenshot showing the option select \'Existing Azure Pipelines YAML file\'](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image6.png)
...
> ![Screenshot showing how to select an existing YAML file](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image7.png)
...
> ![Screenshot showing the artifacts and stages of the pipeline](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image8.png)
3.  

4.  Add this library to the release pipeline. The variables inside this library would be used by the ARM template task.

> ![Screenshot showing the Variables inside the library](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image9.png)
5.  Add the ARM template file present in the repository to this ARM Template deployment task.

> ![Screenshot showing template.json](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image10.png)
>
> ![Screenshot depicting the ARM template deployment](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image11.png)
6.  

7.  Update the file location of the ParseARM script in the pipeline.

> ![Screenshot showing the file location of ParseARM script in the pipeline](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image12.png)
>
> ![Screenshot showing ParseARMOutput.ps1](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image13.png)
8.  Update the value of service connection in the tasks.

> ![Screenshot showing the update of values of the service connection in the tasks](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image14.png)
...
> ![Screenshot showing validation of the resources](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image15.png)
...
> ![screenshot showing the validation of the simulator web job running](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image16.png)
...
> ![Screenshot depicting the key vault library creation in ADO](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image17.png)
...
> ![Screenshot showing the parameters added](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image18.png)
...
> ![Screenshot showing azure-pipelines.yml and the service connection values](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image19.png)
### 
...
> ![Screenshot showing the value of the service connection updated for AKS cluster in the tasks](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image20.png)
3.  

4.  If this is the first run, then disable the delete task from the pipeline.

> ![Screenshot showing control options and the Enable checkbox to disable the delete task from the pipeline](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image21.png)
5.  Create a release from the release pipeline created earlier.

> ![Screenshot showing the Create release option](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image22.png)
...
> ![Screenshot showing successful deployment](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image23.png)
>
> ![Screenshot of Lens app](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image24.png)
6.  If everything looks good, enable the delete task that was previously disabled.

> ![Screenshot depicting the enabling of the delete task previously disabled](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image25.png)
## 
...
> ![Screenshot of ADO WebJobs with the stop option highlighted](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image26.png)
...
![Screenshot of Device twin (SmartSimulator)](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image27.png)
...
> ![Screenshot of IOTHub\'s device management that shows a list of devices to modify](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image28.png)
2.  Select Device Twin from the top menu.

> ![Screenshot of selected device and the option of device twin highlighted](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image29.png)
...
> ![Screenshot showing Changing the attribute value in the device twin of parameters according to the requirement ](./media/AOT_Simulator_IoTHub_Extractor_Deployment_Guide/image30.png)
