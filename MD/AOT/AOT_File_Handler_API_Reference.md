---
sidebar_position: 2
title: AOT File Handler API Reference
---
...
| Protocol | HTTPS |
| --- | --- |
| PATH AOT (Cognite)(Public Exposure) | [[https://apim-mw-aot-dev.azure-api.net/api/filehandler/files/upload]](https://apim-mw-aot-dev.azure-api.net/api/filehandler/files/upload) |
| PATH AOT (Azure)(Public Exposure) | [[https://apim-aot-azure-dev.azure-api.net/api/filehandler/files/upload]](https://apim-aot-azure-dev.azure-api.net/api/filehandler/files/upload) |
| METHOD | POST |
