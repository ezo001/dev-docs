---
sidebar_position: 2
title: AOT Smart KPIs PM Integration Guide
---
...
![data permission workflow diagram](./media/AOT_Smart_KPIs_PM_Integration_Guide/image2.png)
...
![AOT application interface showing the access assigned to user](./media/AOT_Smart_KPIs_PM_Integration_Guide/image3.png)

![AOT application interface showing the performance KPI](./media/AOT_Smart_KPIs_PM_Integration_Guide/image4.png)
...
![Screenshot of performance plant](./media/AOT_Smart_KPIs_PM_Integration_Guide/image5.png)
...
![Screenshot showing the time series tab with values of Role IDs highlighted.](./media/AOT_Smart_KPIs_PM_Integration_Guide/image6.png)
...
![Screenshot showing Postman query to add user roles to assets](./media/AOT_Smart_KPIs_PM_Integration_Guide/image7.png)
...
![Screenshot of assets visible in CDF admin portal](./media/AOT_Smart_KPIs_PM_Integration_Guide/image8.png)
...
![Screenshot of queries to add roles to timeseries](./media/AOT_Smart_KPIs_PM_Integration_Guide/image9.png)
...
![Screenshot of the roles visible in Timeseries ](./media/AOT_Smart_KPIs_PM_Integration_Guide/image10.png)
