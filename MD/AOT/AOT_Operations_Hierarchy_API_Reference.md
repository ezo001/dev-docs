---
sidebar_position: 2
title: AOT Operations Hierarchy API Reference
---
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH AOT (Cognite) (Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/oh-module/parentassets) |
| PATH AOT (Azure) (Public Exposure) | [link](https://apim-aot-azure-dev.azure-api.net/api/oh-module/parentassets) |
| METHOD | GET |
| CONTENT TYPE | application / json |
...
| ### | API Specifications |
| PROTOCOL | HTTPS |
| PATH AOT (Cognite) (Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/oh-module/assets/pin) |
| PATH AOT (Azure) (Public Exposure) | [link](https://apim-aot-azure-dev.azure-api.net/api/oh-module/assets/pin) |
| METHOD | POST |
| CONTENT TYPE | application / json |
