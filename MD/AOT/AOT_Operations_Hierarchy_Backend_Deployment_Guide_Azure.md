---
sidebar_position: 2
title: AOT Operations Hierarchy Backend Deployment Guide Azure
---
...
> ![Creating library with variable group in ADO](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image2.png)
3.  
...
![Module APIs pipeline file](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image3.png)

![Config APIs pipeline file](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image4.png)

![Pipeline file updation](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image5.png)
...
> ![azure-pipelines.yml file folder structure for OH module APIs](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image6.png)
-   Consumption/DataAccess/OperationsHierarchy/Configuration/oh_config_middleware/oh_config_ms/pipeline

> ![azure pipeline yml file in folder structure for config middleware](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image7.png)
...
![APIM screen for module APIs](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image8.png)

![APIM screen for config APIs](./media/AOT_Operations_Hierarchy_Backend_Deployment_Guide_Azure/image9.png)
