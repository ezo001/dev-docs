---
sidebar_position: 2
title: AOT Twin Builder and Twin Viewer Architecture Blueprint
---
...
![Diagram of Twin Viewer Unity App Architecture](./media/AOT_Twin_Builder_and_Twin_Viewer_Architecture_Blueprint/image2.png)
...
![Simple diagram showing how the React App powers the micro frontend 2D viewer.](./media/AOT_Twin_Builder_and_Twin_Viewer_Architecture_Blueprint/image3.png)
...
![Flowchart showing interactions between Unity Visualizer app, AOT Main App, Operation Hierarchy (OH) app, and MFE Unity Visualizer app. The Unity Visualizer app follows five steps: loading the default layout, selecting assets and syncing with OH app, closing detail panels, navigating to Twin Viewer, and highlighting assets via OH events. The AOT Main App sends events to both Unity Visualizer and OH apps, while the MFE Unity Visualizer app parses OH events. Arrows indicate event-driven communication across components to manage asset visualization and hierarchy.](./media/AOT_Twin_Builder_and_Twin_Viewer_Architecture_Blueprint/image5.png)
...
![Flowchart showing how model lists are fetched and processed in a system involving 3DCE, AOT Main App, and AOT Middleware API. Depending on whether the environment is set to \'couple\' or \'decouple\', the model list is retrieved from either 3DCE or AOT. The list is then sent to the AOT Middleware API, which distributes it to Twin Viewer, Model, POI Editor, Mapper, and Plant Layout components within Twin Builder.](./media/AOT_Twin_Builder_and_Twin_Viewer_Architecture_Blueprint/image7.png)
