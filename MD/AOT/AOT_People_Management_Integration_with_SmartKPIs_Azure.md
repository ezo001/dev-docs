---
sidebar_position: 2
title: AOT People Management Integration with SmartKPIs Azure
---
...
| Data Permissions | Permission defined to AOT business objects (asset hierarchy, KPIs, Insights, etc.) based on roles and responsibilities. The users have access only to the data their roles are mapped to. The following sections describe the two different permission types in detail. |
...
![functional permissions for PM with AOT components](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image2.png)
...
![data permissions for PM with AOT components](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image3.png)
...
> ![Diagram showing authentication and authorization process ](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image4.png)
...
![Diagram depicting the cache mappings](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image5.png)
...
![data permission workflow diagram](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image6.png)
...
> ![MSSQL KpiMaster table in Azure Portal](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image7.png)
...
![A screenshot of Azure Digital Twins Explorer showing the role mapping info ](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image8.png)
...
> ![AOT UI showing the relevant KPIs](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image9.png)
...
![Diagram showing a sample integration, that is, how the people management component is integrated with the Smart KPIs component using APIs ](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image10.png)
...
![Result screenshot as per example described](./media/AOT_People_Management_Integration_with_SmartKPIs_Azure/image11.png)
