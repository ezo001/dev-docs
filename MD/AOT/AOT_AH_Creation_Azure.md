...
![Blob container structure](./media/AOT_AH_Creation_Azure/image2.png)
...
![asset-processed-template structure](./media/AOT_AH_Creation_Azure/image3.png)
...
![asset-raw-template structure](./media/AOT_AH_Creation_Azure/image4.png)
...
> ![AssetConfigurationColumns JSON file](./media/AOT_AH_Creation_Azure/image5.png)
>
...
![pipelines and datasets](./media/AOT_AH_Creation_Azure/image6.png)
...
![ADF Parent pipeline AH flow](./media/AOT_AH_Creation_Azure/image7.png)
...
![ADF child pipeline JOBS API flow](./media/AOT_AH_Creation_Azure/image8.png)

After successful execution of this pipeline, logs will appear as below on the Azure Data Factory studio.

![execution logs](./media/AOT_AH_Creation_Azure/image9.png)
...
![ADF-child-pipeline-DurableFunctionApp flow](./media/AOT_AH_Creation_Azure/image10.png)

Successful execution of this pipeline appears as below.

![execution logs](./media/AOT_AH_Creation_Azure/image11.png)
...
![ADT explorer showing the result of the ADF pipeline with OH of the twins created](./media/AOT_AH_Creation_Azure/image12.png)
...
![Twin properties showing the update](./media/AOT_AH_Creation_Azure/image13.png)
...
![Twin properties showing the Archive](./media/AOT_AH_Creation_Azure/image14.png)
