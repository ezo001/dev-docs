---
sidebar_position: 2
title: AOT SAP WO Extractor Deployment Guide
---
...
![Diagram depicting the Data Integration Architecture](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image2.png)
...
> ![Screenshot of function module showing the \"insert row\" button](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image3.png)
4.  
...
> ![](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image15.png)
...
> ![Screenshot of SAP](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image16.png)
...
| 4. | While creating the SEGW project, add everything to the workbench request. The final package is now created. &gt; ![Screenshot of SAP](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image17.png)
|  |
| 5. | Validate the final transport request once it is successfully created. &gt; ![Screenshot of SAP](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image18.png)
|  |
...
| SapWOkey | Provide the SAP key to perform authentication with the SAP system &gt; ![screenshot of secret creation ](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image19.png)
3. |
| 4. | Create a key vault library in Azure DevOps and add the secrets created in the previous step. &gt; ![screenshot of key vault creation](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image20.png)
|  |
...
| SAP_CLI_PROJECT_NAME | Provide SonarQube project name for SAP WO extractor. &gt; ![screenshot of library](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image21.png)
6. |
...
| - | Provide timer value in seconds to schedule the extractor. &gt; ![screenshot of timer value](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image23.png)
|  |
...
| idp-authentication. tenant | Use the tenant Id for CDF added in the Azure DevOps library in earlier steps &gt; ![screenshot specifying the parameter to connect Cognite server](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image24.png)
|  |
...
| Log_Table | Provide a log table name that will be used in CDF RAW &gt; ![Screenshot of the SAP WO related config parameters](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image25.png)
...
| contacts.sendnotification | Optional - Provide notification value. If the send notification value is true, then mail is sent to the respective mail Id else no mail is sent. &gt; ![Screenshot of the extraction pipeline related config parameters](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image26.png)
|  |
...
> ![screenshot of azure devops](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image27.png)
2.  Select *Azure Repos Git* and then select the *Repository Name* that contains SAP WO Extractor code and pipeline files.

![screenshot of azure devops](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image28.png)

3.  Select \'*Existing Azure Pipelines YAML file\'*.

> ![screenshot of azure devops](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image29.png)
...
> ![screenshot of azure devops](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image30.png)
5.  Review and save.
...
> ![screenshot of azure devops](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image37.png)
10. Validate SAP WO Extractor logs on the [Lens](https://k8slens.dev/) app.

> ![screenshot of lens app](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image38.png)
11. 
...
>
> ![Screenshot of failure message in CDF portal](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image45.png)
## 
...
> ![screenshot of timer value](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image47.png)
...
| - | pythonXX.dll |
| - | pythoncomXX.dll |
| - | pywintypesXX.dll &gt; ![screenshot of windows start menu](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image49.png)
> &gt; ![screenshot of installed libraries](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image50.png)
|  |
...
> ![screenshot of windows services app actions](./media/AOT_SAP_WO_Extractor_Deployment_Guide/image51.png)
