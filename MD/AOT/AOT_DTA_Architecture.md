...
<p class="doc-version">Release Version: 2.5![](./media/AOT_DTA_Architecture/image1.png)</p>
![](./media/AOT_DTA_Architecture/image2.png)
...
This document explains the architecture and integration of the generative AI based Digital Twin Assistant that is integrated into the user interfaces for the AOT components
...
-   [AOT Repo](https://dev.azure.com/DigitalPlantProject/Marilyn%20V/_git/MarilynVPlatform)
...
![A diagram of a diagram AI-generated content may be incorrect.](./media/AOT_DTA_Architecture/image4.png)
...
![A screenshot of a computer AI-generated content may be incorrect.](./media/AOT_DTA_Architecture/image5.png)
...
| **Name** | **Description** |
| --- | --- |
| Rephrase Agent | Prompt for this can be found at the function rephrase in the file [AOT_template.py](https://dev.azure.com/DigitalPlantProject/Marilyn%20V/_git/AOT-Azure?path=/Consumption/DataAccess/GenAI/GenAIQueryAPI/genai_middleware/genai_ms/app/gen_ai/AOT_template.py). Its purpose is to transform/rephrase the question using the chat history to have the context memory accessible to the agents further down the pipeline |
| Router Agent | Prompt for this can be found at the function route_classify in the file [AOT_template.py](https://dev.azure.com/DigitalPlantProject/Marilyn%20V/_git/AOT-Azure?path=/Consumption/DataAccess/GenAI/GenAIQueryAPI/genai_middleware/genai_ms/app/gen_ai/AOT_template.py). Its purpose is to determine which of the two sources the question can be answered from GraphQL (or) Unstructured. |
...
| 1. | Detect the intent of the user question from the available list of master intents. Prompt for this can be found at the function intent_classify in the file [AOT_template.py](https://dev.azure.com/DigitalPlantProject/Marilyn%20V/_git/AOT-Azure?path=/Consumption/DataAccess/GenAI/GenAIQueryAPI/genai_middleware/genai_ms/app/gen_ai/AOT_template.py) |
