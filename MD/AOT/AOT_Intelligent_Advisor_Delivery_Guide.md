---
sidebar_position: 2
title: AOT Intelligent Advisor Delivery Guide
---
...
| **Related Assets / Alternatives** | Intelligent Advisor UI Guide, Intelligent Advisor Delivery Guide ![](./media/AOT_Intelligent_Advisor_Delivery_Guide/image2.png)
|  |
...
> ![AOT configuration](./media/AOT_Intelligent_Advisor_Delivery_Guide/image3.png)
...
![Flow diagram for leveraging azure and CDF to generate insights](./media/AOT_Intelligent_Advisor_Delivery_Guide/image4.png)
...
![IA config db structure](./media/AOT_Intelligent_Advisor_Delivery_Guide/image6.png)
...
> ![Table structure](./media/AOT_Intelligent_Advisor_Delivery_Guide/image7.png)
...
![Insight category configurations](./media/AOT_Intelligent_Advisor_Delivery_Guide/image8.png)
...
> ![Insight category configurations parameters](./media/AOT_Intelligent_Advisor_Delivery_Guide/image9.png)
#### 
...
![DB structure in azure](./media/AOT_Intelligent_Advisor_Delivery_Guide/image10.png)
...
![ML database model structure](./media/AOT_Intelligent_Advisor_Delivery_Guide/image11.png)
...
![Flow diagram for UC1 -- Predicting Control Valve Failure](./media/AOT_Intelligent_Advisor_Delivery_Guide/image12.png)
...
![Flow diagram for UC2 -- Smart KPI for OEE](./media/AOT_Intelligent_Advisor_Delivery_Guide/image13.png)
...
![AOT Insight template hierarchy diagram](./media/AOT_Intelligent_Advisor_Delivery_Guide/image14.png)

The screenshot below shows the IA configuration of the insight category and insight template hierarchy.

![IA configuration of insight category](./media/AOT_Intelligent_Advisor_Delivery_Guide/image15.png)

The template is used by UI, and it has details about insights.

![Template used by UI that has details about insights](./media/AOT_Intelligent_Advisor_Delivery_Guide/image16.png)
