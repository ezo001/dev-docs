---
sidebar_position: 2
title: AOT Azure Intelligent Advisor Delivery Guide
---
...
![Automatic Insight Generation Diagram](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image2.jpeg)
...
| Delete configuration | This API deletes the configuration from model_configuration and dedicated_model_configuration tables based on the configuration ID in Azure DB. Generic scheduler Microservice will trigger only after create/update/delete of predictive failure configurations. More information on APIs can be found here: [AOT Intelligent Advisor API Reference](https://industryxdevhub.accenture.com/assetdetails/43). |
...
| ModelTrigger API | This API triggers the model to start consuming the messages and perform the operations. Note that the ModelTrigger API is triggered when the AOT-Azure-IA-MW-MS Middleware microservice is run and the getInsightList API is hit for the first time. |
...
![IA config db structure](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image4.png)
...
![table structure of sql-ia-config-dev-dev](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image5.png)
...
![query for insight category configuration](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image6.png)
...
![query for insight category configuration parameters](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image7.png)
...
![DB structure in azure](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image8.png)
...
![UC1 -- Predicting Control Valve Failure flow diagram](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image9.png)
...
![UC2- smart KPI for OEE flow diagram](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image10.png)
...
![AOT Insight template hierarchy diagram](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image11.png)

The screenshot below shows the IA configuration of the insight template in the SQL table.

> ![IA configuration of the insight template in SQL table](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image12.png)
The template is used by the UI and has details about the insights.

![Insight details visible on the UI](./media/AOT_Azure_Intelligent_Advisor_Delivery_Guide/image13.png)
