---
sidebar_position: 2
title: AOT Digital Assistant Integration Guide
---
...
| **Field** | **Value** |
| --- | --- |
| **Asset / Solution Name** | Accenture Operations Twin / Digital Twin Assistant |
...
This document provides detailed information on how to interact with the Digital Twin Assistant using GraphQL, including the structure of available queries, mutations, and their input and output parameters. The document covers authentication procedures, endpoint usage, and integration guidelines, ensuring that developers and integrators can seamlessly connect their applications to the AOT platform. Additionally, it offers best practices, troubleshooting tips, and examples to help users optimize their use of the GraphQL Mesh APIs for enhanced operational insights and decision-making within complex IT and OT environments.[]\{#_Toc171608331 .anchor\}
...
-   [AOT Dev](https://operationstwin-dev2.accenturedigitalplant.com/home/globe)

-   [AOT Test](https://operationstwin-test.accenturedigitalplant.com/home/globe)
...
![authentication and authorization](./media/AOT_Digital_Assistant_Integration_Guide/image3.png)
...
![authorization error](./media/AOT_Digital_Assistant_Integration_Guide/image4.png)
...
> ![installation commands](./media/AOT_Digital_Assistant_Integration_Guide/image5.png)
...
> ![installation process depicting the process from step 7](./media/AOT_Digital_Assistant_Integration_Guide/image6.png)
### 
...
![graphQL query structure](./media/AOT_Digital_Assistant_Integration_Guide/image7.png)
...
![graphQL query structure](./media/AOT_Digital_Assistant_Integration_Guide/image8.png)
...
![graphQL query structure](./media/AOT_Digital_Assistant_Integration_Guide/image9.png)
...
![graphQL query structure](./media/AOT_Digital_Assistant_Integration_Guide/image10.png)
...
![GraphQL gateway flow diagram](./media/AOT_Digital_Assistant_Integration_Guide/image11.png)
...
> ![roleids in the form of a list](./media/AOT_Digital_Assistant_Integration_Guide/image12.png)
...
> ![values of list](./media/AOT_Digital_Assistant_Integration_Guide/image13.png)
...
![decoded auth token](./media/AOT_Digital_Assistant_Integration_Guide/image14.png)

![plugin useExtendContext](./media/AOT_Digital_Assistant_Integration_Guide/image15.png)
...
![querying process](./media/AOT_Digital_Assistant_Integration_Guide/image16.png)

![querying process](./media/AOT_Digital_Assistant_Integration_Guide/image17.png)
...
![deviation API being fetched](./media/AOT_Digital_Assistant_Integration_Guide/image18.png)
...
![response for the example](./media/AOT_Digital_Assistant_Integration_Guide/image20.png)
