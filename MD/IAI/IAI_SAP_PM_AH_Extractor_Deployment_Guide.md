---
sidebar_position: 2
title: IAI SAP PM AH Extractor Deployment Guide
---
...
## ![](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image1.png)
...
> ![Screenshot of SAP with row button highlighted](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image3.png)
1.  
...
> ![](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image12.png)
...
> ![](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image15.png)
...
> ![Screenshot of SAP](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image16.png)
3.  
...
| 5. | While creating the SEGW project, add everything to the workbench request. The final package is now created. &gt; ![Screenshot of SAP](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image17.png)
|  |
| 6. | Validate the final transport request once it is successfully created. &gt; ![Screenshot of SAP](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image18.png)
|  |
...
| 3. | Create a key vault library in Azure DevOps and add the secrets created in the previous step. &gt; ![screenshot of key vault creation](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image19.png)
|  |
...
| 5. | Navigate to the pipelines file location \"Source/Extractors/sap-extractor/pipeline/Dev/azure-pipelines.yml\" and ensure that the pipeline refers to the libraries created in the previous steps. &gt; ![screenshot of library](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image20.png)
|  |
| 6. | Configure the following parameters in the configuration file for the SAP extractor: |
| - | Provide timer value in seconds to schedule the extractor. &gt; ![screenshot of timer value](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image21.png)
|  |
...
| idp-authentication. tenant | Use the tenant Id for CDF added in the Azure DevOps library in earlier steps &gt; ![screenshot specifying the parameter to connect Cognite server](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image22.png)
|  |
...
| Log_Table | Provide a log table name that will be used in CDF RAW &gt; ![Screenshot of code showing the Asset hierarchy functional locations and Equipments](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image23.png)
...
| contacts.sendnotification | Optional - Provide notification value. If the send notification value is true, then mail is sent to the respective mail Id else no mail is sent. &gt; ![screenshot of extraction pipeline parameters](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image24.png)
|  |
...
![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image25.png)

2.  Select Azure Repos Git and then select the Repository Name that contains SAP Extractor code and pipeline files.

![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image26.png)

3.  Select \'Existing Azure Pipelines YAML file\'.

![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image27.png)
...
> ![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image29.png)
### 
...
![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image30.png)
...
![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image33.png)

7.  Once the release is completed, confirm successful deployment on Azure DevOps.

![screenshot of azure devops](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image34.png)
...
> ![screenshot of failure message in cdf](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image40.png)
## 
...
> ![screenshot of log file path](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image41.png)
-   Add timer value in seconds to schedule the extractor

> ![screenshot of timer value](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image42.png)
...
| - | pythonXX.dll |
| - | pythoncomXX.dll |
| - | pywintypesXX.dll &gt; ![screenshot of installed libraries](./media/IAI_SAP_PM_AH_Extractor_Deployment_Guide/image45.png)
|  |
