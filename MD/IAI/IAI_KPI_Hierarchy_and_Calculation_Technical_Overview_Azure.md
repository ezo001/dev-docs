...
-   [IAI Simulator and IoTHub Extractor Deployment Guide](https://industryxdevhub.accenture.com/assetdetails/46)

-   [IAI UoM Technical Reference](https://industryxdevhub.accenture.com/assetdetails/87)

-   [IAI Generic Scheduler Technical Overview](https://industryxdevhub.accenture.com/assetdetails/83)
...
| **Term** | **Definition** |
| --- | --- |
| IAI (Industrial AI Foundation) | A suite of software accelerators and tools designed to integrate product, process, and live data from IT and OT systems, providing a comprehensive view of operations for better decision-making and process optimization. |
...
![KPI hierarchy in AOT](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image2.png)

The following image depicts the KPI details in the Azure Digital Twins (ADT) Explorer.

![ KPI details in the Azure Digital Twins (ADT) Explorer.](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image3.png)
...
![the order of flow from one component to another](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image6.png)
...
![scheduling and sequencing process flow diagram](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image7.png)
...
![the architecture of the orchestrator service](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image8.png)
...
![Simulated value creation](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image9.png)
...
| MT2 | UoM2 (primary) \- |
| MT3 | UoM3, UoM3.1 (primary) \- **Flow** ![UoM Conversion procedure flow diagram ](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image10.png)
|  |
...
-   For Batch KPIs, the system uses event-based data from Cosmos DB to determine time ranges and compute KPIs using the corresponding time-series data.\
    ![Diagram showing calculation of actual value at plant level](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image11.png)
...
4.  Result Computation: The Unit of Measurement (UoM) defined in the template helps in converting the computed value from the IAI standard system format to the user-configured format based on the need. By default, all the computed values are converted to IAI standard format.
...
![details of the KPI ](./media/IAI_KPI_Hierarchy_and_Calculation_Technical_Overview_Azure/image12.png)
