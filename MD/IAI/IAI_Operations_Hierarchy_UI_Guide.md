---
sidebar_position: 2
title: IAI Operations Hierarchy UI Guide
---
...
Operations Hierarchy (OH) is a component of IAI that helps the user to navigate through the plant\'s hierarchy and to view 360-degree information associated with each node. A node, also known as an entity, could be a Line, Unit, System, Sub-system, Equipment, or something similar. The UI provides a unified view that helps the business user to explore the contextualized data that in turn would help to speed up the problem investigation and analysis.

The OH Entity Viewer allows customization of the visualized UI. An authenticated user can define an unlimited number of tabs with subsequent asset data to be visualized. Because OH is integrated with IAI\'s People Management (PM) component, only data that the user is allowed to see, as dictated by the PM configuration, will be displayed.

### Purpose

This document explains how to use the Operations Hierarchy component of the IAI UI, including the Entity Viewer.
...
-   [IAI OH Resources](https://industryxdevhub.accenture.com/asset-home;search_text=operations%20hierarchy)
...
| --- | --- |
| **IAI (Industrial AI Foundation)** | Software suite for integrating and contextualizing factory-to-cloud operations data. |
| **Operations Hierarchy (OH)** | IAI component for navigating plant hierarchy and viewing contextualized asset data. |
...
![Operations Hierarchy in the side nav panel, collapsed and expanded](./media/IAI_Operations_Hierarchy_UI_Guide/image2.png)
...
1.  The Overview option launches the overview page, which displays tiles for every IAI component. Clicking the Operations Hierarchy tile (3) launches the Entity Viewer page.
...
![Options under the dot menu with Overview and Operations Hierarchy options highlighted](./media/IAI_Operations_Hierarchy_UI_Guide/image3.png)

![Operations Hierarchy tile on the Overview page](./media/IAI_Operations_Hierarchy_UI_Guide/image4.png)
...
![OH nav panel with features highlighted as per the corresponding text](./media/IAI_Operations_Hierarchy_UI_Guide/image5.png)

| **Icon** | **Asset** |
| --- | --- |
| ![icon for company](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Company |
| ![icon for regions](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Region |
| ![icon for Plant](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Plant |
| ![icon for Unit](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Unit |
| ![icon for Area](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Area |
| ![icon for System](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| System |
| ![icon for Equipment](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Equipment |
| ![Icon for Instrument](./media/IAI_Operations_Hierarchy_UI_Guide/image6.png)
| Instrument |
...
![OH Search feature](./media/IAI_Operations_Hierarchy_UI_Guide/image7.png)
...
> ![OH filter feature](./media/IAI_Operations_Hierarchy_UI_Guide/image8.png)
...
2.  Clicking the ![(X) icon](./media/IAI_Operations_Hierarchy_UI_Guide/image9.png)
...
![OH nav panel with the selection features highlighted](./media/IAI_Operations_Hierarchy_UI_Guide/image10.png)
...
![Entity Viewer interface with features highlighted as per the numbered callouts in the corresponding text.](./media/IAI_Operations_Hierarchy_UI_Guide/image11.jpeg)
...
![Upload template pop-up window asking to select/browse files](./media/IAI_Operations_Hierarchy_UI_Guide/image12.png)

Once a valid file has been specified, the *START UPLOADING* button is enabled.

![Upload template window that shows the \'Start Uploading\' option](./media/IAI_Operations_Hierarchy_UI_Guide/image13.png)
...
![UPLOAD TEMPLATE window that shows the successfully uploaded file](./media/IAI_Operations_Hierarchy_UI_Guide/image14.png)
...
![Video thumbnail for a video that shows the details of a sample configuration](./media/IAI_Operations_Hierarchy_UI_Guide/image15.png)
