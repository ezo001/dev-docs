---
sidebar_position: 2
title: IAI People Management API Reference
hide_title: true
---
...
This reference document includes information about paths, inputs, outputs, and error management of IAI\'s People Management configuration and middleware APIs.
...
| --- | --- |
| IAI (Industrial AI Foundation) | A collection of software accelerators and tools designed to integrate product, process, and live data from disparate IT and OT systems, providing a comprehensive view of operations for better decision-making and process optimization. |
| Active Directory (AD) | A Microsoft directory service used for identity and access management, integrated with IAI People Management for user and group management. |
| Department | An organizational unit within IAI, which can be created, updated, revived, or deleted using the API. |
| Role | A set of permissions or responsibilities assigned to users or departments in IAI, which can be managed via the API. |
| Group | A collection of users in Active Directory, which can be mapped to roles within IAI. |
...
| Middleware API | APIs that provide a unified interface between the People Management Database and IAI Applications, enabling backend data visualization and actions. |
| Create/Update/Delete Operations | API functions that allow the creation, modification, or removal of roles and departments in IAI. |
...
The middleware APIs provide a unified interface between the People Management Database (backend of IAI) and the consumers of the data (IAI Applications). These APIs are not only used by the People Management Configuration User Interface but are also consumed by other IAI components to get User (Roles and Departments) specific Information. The complete list of APIs can be found below.
...
This API is used to Create, Update, or Revive an IAI Department based on the request body.

-   To create a department, department details are needed except the department ID, which is autogenerated.

-   To update or revive a department, departmentId is mandatory and it returns the corresponding IAI department details.
...
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/departments) |
| PATH IAI (Azure)(Public Exposure) | [https://apim-aot-azure-dev.azure-api.net/api/people-management/departments] |
| METHOD | POST |
...
This API is used to Create, Update, or Revive an IAI Role based on the request body. To create a role, role details are needed except RoleID, as it is auto-generated. To update or revive a role, RoleID is mandatory, and it returns the corresponding IAI role details.
...
| ReviveArchivedRole | Provide a ReviveArchivedRole as true to revive the IAI role O Boolean |
...
| Parameter | Description Type |
| --- | --- |
| RoleId | The role id of an IAI roles String |
| RoleName | The role name of an IAI roles String |
...
This API is used for validating the IAI role name within a plant based on a known role name and list of role IDs linked to the plant.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/\{roleName\}/validateName?roleIds=\{roleIds\}) |
...
This API is used for validating the IAI department name.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/departments/\{departmentName\}/validateName) |
...
This API is used for validating IAI department deletion.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/departments/\{departmentId\}/validateDeletion) |
...
This API is used for validating IAI role deletion.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI(Cognite)(Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/\{roleId\}/validateDeletion](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/%7broleId%7d/validateDeletion) |
...
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) |  |
| PATH IAI (Azure)(Public Exposure) | [link](https://apim-aot-azure-dev.azure-api.net/api/people-management/groups/search) |
| METHOD | POST |
...
This API is used for searching users from AD or IAI. While IAI users can be filtered using RoleIDs, no such filtering is available to AD users.
...
| Parameter | Description Type |
| --- | --- |
| UserId | User ID of the IAI user String |
| DisplayName | The display name of the IAI user on the UI String |
| FirstName | First name of the IAI user String |
| LastName | Last name of the IAI user String |
...
\"AOTUsersOnly\": \"True/False (Give this value as true if the search should be only on IAI users and false if on all AD users)\",
...
This API is used for IAI users based on ID. If no ID is given, then all IAI users will be returned.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite) (Public Exposure) | Without userId: With userId: /\{userId\} |
...
| Parameter | Description Type |
| --- | --- |
| UserId | The user id of the IAI user String |
| DisplayName | The display name of the IAI user on the UI String |
| FirstName | First name of the IAI user String |
| LastName | Last name of the IAI user String |
| UserPrincipalName | User principal name of the IAI user String |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/people-management/users/byDepartments](https://apim-mw-aot-dev.azure-api.net/api/people-management/users/byRoles) |
...
This API is used for fetching all IAI roles. If RoleID is given, it will return the corresponding IAI Role.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | Without RoleId: With RoleId: [https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/\{roleId](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/%7broleId)[\}] |
...
| RoleName | Role Name of the IAI roles String |
| RoleDescription | Role Description of the IAI Roles String |
| RoleType | Role type of the IAI roles String |
...
| CreatedBy | Name of the user who created the IAI role String |
| CreatedTime | Creation Time of the IAI Role Date Time |
| UsersCount | Count of users in the IAI Roles String |
| UserId | The user ID of the IAI user String |
| DisplayName | UI Display name of the IAI user String |
| PhoneNumber | Phone number of the IAI user String |
| Email | Email of the IAI user String |
| GroupId | Group ID of the AD Group String |
...
| RoleId | Role id of the IAI user roles String |
| RoleName | Role name of the IAI user roles String |
| RoleDescription | The role description of the IAI user roles String |
| RoleType | Role type of the IAI user roles String |
| IsSensitive | This is a Boolean value. If the value is true, there are some sensitive KPIs that users in those roles can access, otherwise not Boolean |
...
This API is used for retrieving a list of all the admin roles in IAI.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/admin) |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/\{roleId\}) |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | Without department Id: With department Id: /\{departmentId\} |
...
| --- | --- |
| DepartmentId | Department ID of IAI user departments String |
| DepartmentName | Department name of IAI user departments String |
| DepartmentDescription | Department description of IAI user departments String |
...
| Parameter | Description Type |
| --- | --- |
| RoleId | Role ID of an IAI user roles String |
| RoleName | Role name of an IAI user roles String |
| RoleDescription | The role description of an IAI user\'s roles String |
| RoleType | Role type of an IAI user roles String |
...
This API is used for disabling (soft deleting) the IAI department. The response contains a message with information about whether the department mapped to the given department ID was successfully deleted.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/people-management/departments/\{departmentId](https://apim-mw-aot-dev.azure-api.net/api/people-management/departments/%7bdepartmentId)[\}] |
...
This API is used to disable (soft delete) the IAI role. The response contains a message with information about whether the role mapped to the given RoleId was successfully deleted.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/\{roleId](https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/%7broleId)[\}] |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/syncservice) |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/syncservice/lastRun) |
...
This API is used to map the given IAI user to the given IAI role.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/UsersWithRoles) |
...
This API is used to map the given AD group to the given IAI role.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/GroupsWithRoles] |
...
This API is used to map the given IAI department to the given IAI role.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/RolesWithDepartment) |
...
This API is used to soft delete the IAI role and IAI department mapping. The response will have a message with information on whether the mapping between the given IAI department and the IAI role was successfully deleted or not.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite) (Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/RolesWithDepartments/\{deparmentId\}/\{roleId\}) |
...
Use this API to soft delete the IAI role and ADGroup mapping. The response will have a message with information on whether mapping between the given IAI role and ADGroup was successfully deleted or not.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/GroupsWithRoles/\{groupId\}/\{roleId\}) |
...
This API is used to soft delete IAI user and IAI role mapping. The response will have a message with information on whether mapping between the given IAI role and the IAI user was successfully deleted or not.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/mappings/UsersWithRoles/\{userId\}/\{roleId\}) |
...
This API is used to fetch all the AD Groups and their respective associated IAI Roles.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/groups/directRoles) |
...
This API is used to fetch a list of IAI Roles based on User ID. If the User ID is invalid, an empty list will be returned.
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/users/\{UserId\}/directRoles) |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite)(Public Exposure) | [link](https://apim-mw-aot-dev.azure-api.net/api/people-management/user/\{UserId\}/groups) |
...
This API is used to send messages to a list of users, groups, or all users using Azure Web PubSub Service based on the request body. Azure Web PubSub is an internal API, as it is used only by the backend of an IAI application and is not exposed to end users.
...
| Parameter | Description | M/O | Type |
| --- | --- | --- | --- |
| hub | Provide a name for the hub that will be used for web pub sub-client connections. | M | String |
| sendTo | Provide the receiver type to whom the message should be sent. Available options are as follows: | M | String |
