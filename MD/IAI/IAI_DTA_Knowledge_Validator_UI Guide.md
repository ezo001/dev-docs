---
sidebar_position: 2
title: IAI DTA Knowledge Validator UI Guide
hide_title: true
---

<div class="doc-title-block">
<p class="doc-asset-name">Industrial AI Foundation</p>
<p class="doc-topic">Knowledge Validator</p>
...
| **Field** | **Value** |
| --- | --- |
| **Asset / Solution Name** | Industrial AI Foundation / Knowledge Validation Agent |
...
This guide explains how to use Expert Knowledge functionality in IAI. It covers the following:
...
-   Accessing validated knowledge within IAI\'s Recommendation Framework
...
-   Familiarity with the IAI application
...
### [zainab.asgar.ali@accenture.comRelated](mailto:zainab.asgar.ali@accenture.comRelated) Links
...
| **Term** | **Definition** |
| --- | --- |
| IAI | Industrial AI Foundation |
| DTA | Digital Twin Assistant -- a chatbot feature in IAI that answers templatized queries |
...
If an image is provided, the agent also generates a short description of it. After the evaluation, the entry is placed in pending state, ready for review by a designated admin user. This ensures that all submitted knowledge entries meet quality standards before becoming part of IAI\'s recommendation framework.
...
This structured review process ensures that only high quality, validated expert knowledge becomes part of IAI\'s knowledge base, enabling reliable and actionable recommendations for future use.
...
The Recommendation Generation feature enables IAI users to leverage captured and validated Expert Knowledge to receive actionable guidance for resolving similar operational insights by using past learnings.
...
This ensures that only validated and relevant expert knowledge is used for recommendations, enhancing the operational excellence within IAI.
...
![A screenshot of a computer AI-generated content may be incorrect.](./media/IAI_DTA_Knowledge_Validator_UI%20Guide/image2.png)
...
![A screenshot of a computer screen AI-generated content may be incorrect.](./media/IAI_DTA_Knowledge_Validator_UI%20Guide/image3.png)
...
The Knowledge Validator is accessed from the side menu bar of IAI.

![](./media/IAI_DTA_Knowledge_Validator_UI%20Guide/image4.png)
...
| Rejected | shows entries that were reviewed and declined. Each tab provides key details for every expert knowledge entry, including: |
| - | Knowledge Title |
| - | Date of Submission |
| - | Knowledge Provider |
| - | Approver |
| - | Date of Approval |
| - | Link to the Expert Knowledge Detail ![A screenshot of a computer AI-generated content may be incorrect.](./media/IAI_DTA_Knowledge_Validator_UI%20Guide/image5.png)
|  |
...
![](./media/IAI_DTA_Knowledge_Validator_UI%20Guide/image6.png)
