---
sidebar_position: 2
title: IAI Stream Analytics Technical Overview Azure
---

<div class="doc-title-block">
<p class="doc-asset-name">Industrial AI Foundation</p>
<p class="doc-topic">Azure Stream Analytics</p>
...
This document describes the technical details of how Azure Stream Analytics is utilized by IAI\'s Azure version.
...
![Azure Stream Analytics Data Flow](./media/IAI_Stream_Analytics_Technical_Overview_Azure/image2.png)
