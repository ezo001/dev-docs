---
sidebar_position: 2
title: IAI Units of Measurement Technical Reference
hide_title: true
---

<div class="doc-title-block">
<p class="doc-asset-name">Industrial AI Foundation</p>
<p class="doc-topic">Units of Measurement</p>
<p class="doc-type">TECHNICAL REFERENCE</p>
</div>
...
| **Field** | **Value** |
| --- | --- |
| **Asset / Solution Name** | Industrial AI Foundation / Units of Measurement |
...
The Units of Measurement Configuration module is an IAI component that helps in providing foundational information on Units of Measurement such as Unit Systems, Units of Measurement, and Units of Measurement conversion formulae that are utilized by IAI\'s Smart KPI and Intelligent Advisor components. This supports IAI in handling various units of measurements as per requirement.

### Purpose

This reference document includes information about the Middleware APIs that help in providing information on Units of Measurement like Unit Systems, Units of Measurement, and Units of Measurement Conversion Formulae that are utilized by other IAI components.
...
| IAI (Analytics Operations Toolkit) | A suite of applications and tools designed to support analytics operations, including handling units of measure and Smart KPIs. |
...
| Smart KPIs | An application within IAI designed to manage and display key performance indicators, including handling mismatches in units of measure. |
...
-   IAI Standard Unit System ID

-   Units of measure present in the IAI Standard Unit System
...
\*See also: [IAI People Management Integration with Smart KPIs](https://industryxdevhub.accenture.com/assetdetails/42)
...
| &gt; GET- GetUnitSystems | API for fetching the list of all the unit systems in IAI. |
...
This API is used for fetching the list of all the unit systems in IAI.
...
| IsStandardUnitSystem | Returns true if the unit system is an IAI Standard unit system String |
...
| PROTOCOL | HTTPS |
| --- | --- |
| PATH IAI (Cognite) (Public Exposure) | [https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit?QueryString=\{QueryString\}] |
...
| ### PROTOCOL | ### HTTPS |
| --- | --- |
| ### PATH IAI (Cognite) (Public Exposure) | ### [link](https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/measurementUnits/byUnitSystemId/\{unitSystemId\}) |
