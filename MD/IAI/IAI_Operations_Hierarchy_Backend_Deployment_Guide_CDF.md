---
sidebar_position: 2
title: IAI Operations Hierarchy Backend Deployment Guide CDF
hide_title: true
---
...
Through this document, a user will gain an understanding of how to deploy the backend for Operations Hierarchy on IAI\'s CDF (Cognite Data Fusion) version, while creating the resources (API management platform) required to manage the necessary APIs. The backend deployment for Operations Hierarchy takes about ten minutes to complete.

### Target Audience

Developers deploying the IAI/OH application.:
...
-   IAI- OperationsHierarchy-Module-IaC-MS

-   IAI- OperationsHierarchy-Config-IaC-MS
...
![Folder structure in OH Module APIs showing the pipeline lines](./media/IAI_Operations_Hierarchy_Backend_Deployment_Guide_CDF/image3.png)

![Folder structure in OH Config APIs showing the pipeline lines](./media/IAI_Operations_Hierarchy_Backend_Deployment_Guide_CDF/image4.png)
...
> ![validate correct set of APIs for Module middleware](./media/IAI_Operations_Hierarchy_Backend_Deployment_Guide_CDF/image5.png)
>
> ![Screenshot of ADO APIM showing the APIs that were created](./media/IAI_Operations_Hierarchy_Backend_Deployment_Guide_CDF/image6.png)
