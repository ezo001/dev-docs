---
sidebar_position: 2
title: IAI Hexagon Extractor Deployment Guide
---
...
> ![Certmgr showing the certificates](./media/IAI_Hexagon_Extractor_Deployment_Guide/image2.png)
...
> ![Certificate Export Wizard window showing the option \"No, do not export the private key\"](./media/IAI_Hexagon_Extractor_Deployment_Guide/image3.png)
-   Click Next and select Base -64 encoded X.509(.CER).

> ![Certificate Export Wizard window showing the option selected \"Base-64 encoded X.509 (.CER)](./media/IAI_Hexagon_Extractor_Deployment_Guide/image4.png)
...
> ![Certificate Export Wizard window showing the field to enter File name.](./media/IAI_Hexagon_Extractor_Deployment_Guide/image5.png)

-   Navigate to Network and Internet settings and connect to SPFVnet.

> ![Screenshot showing the option to connect to SPFVnet](./media/IAI_Hexagon_Extractor_Deployment_Guide/image6.png)
-   In the Remote Desktop Connection, provide the Server IP, username, and password. Then, click Connect.

> ![Screenshot of remote desktop connection](./media/IAI_Hexagon_Extractor_Deployment_Guide/image7.png)
-   In the remote desktop, launch the HxGN SDx Desktop Client.

> ![Screenshot of how to launch HXGN SDX Desktop client from Start menu](./media/IAI_Hexagon_Extractor_Deployment_Guide/image8.png)
...
| - | Check the Trusted Site box and click **OK**. &gt; ![HXGN SDX Dashboard Login. Fields shown are to enter Name, Web host, web directory, and the option to select Trusted site](./media/IAI_Hexagon_Extractor_Deployment_Guide/image9.png)
|  |
...
> ![Screenshot of HxGN SDX Desktop client showing the \'Create/Update Scope\' option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image10.png)
-   To create a new Tag Type, right-click on Tag Types in the left panel and then select New Tag Type.

> ![Screenshot showing the \'New Tag Type\...\' option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image11.png)
-   Under the new Tag Type, create new Tags and select the Parent Tag as per requirement.

> ![Screenshot showing the Parent Tag option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image12.png)
...
> ![Import Mapping in dropdown list using Tag Create Mapping format.](./media/IAI_Hexagon_Extractor_Deployment_Guide/image13.png)
...
> ![Screenshot showing the Load Manager option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image14.png)
-   Select Load Tags (SDx).

> ![Screenshot showing the Load Tags (SDx) option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image15.png)

-   Add text in the Description field and then move to step 2.

> ![Screenshot showing the description field and the option to proceed to Step 2](./media/IAI_Hexagon_Extractor_Deployment_Guide/image16.png)
...
> ![Screenshot showing the option \'Show My Load Jobs\'](./media/IAI_Hexagon_Extractor_Deployment_Guide/image17.png)
-   Select Load Tag Properties.

> ![Screenshot showing the option \'Load Tag Properties\'](./media/IAI_Hexagon_Extractor_Deployment_Guide/image18.png)

-   Add text in the Description field then move to step 2.

> ![Screenshot showing the description field and the option to proceed to Step 2](./media/IAI_Hexagon_Extractor_Deployment_Guide/image19.png)
-   In step 2, upload the tag properties and then click FINISH.

> ![screenshot showing the upload of tag properties and Finish option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image20.png)
-   Validate output file format (design properties of tags).

> ![Output file format (design properties of tags) ](./media/IAI_Hexagon_Extractor_Deployment_Guide/image21.png)
### 
...
> ![Smart API Manager screenshot depicting the Smart Clients page](./media/IAI_Hexagon_Extractor_Deployment_Guide/image22.png)
-   Create a new Smart Client for new URL Configuration (1). Enter the Smart Client's name e.g., SDXAPI (2), and click Next (3).

> ![Screenshot showing creation of new smart client](./media/IAI_Hexagon_Extractor_Deployment_Guide/image23.png)

-   The following window and details are displayed when the smart client is successfully created:

> ![Smart Client window that opens up after naming the smart client as SDXAPI](./media/IAI_Hexagon_Extractor_Deployment_Guide/image24.png)
-   Click on Secret to update the secret.

> ![Screenshot showing the Secret update option](./media/IAI_Hexagon_Extractor_Deployment_Guide/image25.png)
-   Select Secret and copy the Client Secret Value to be used in the hexagon extractor. Then click on Next.

> ![Screenshot depicting the field to update Secret](./media/IAI_Hexagon_Extractor_Deployment_Guide/image26.png)
## 
...
> ![Create a secret window](./media/IAI_Hexagon_Extractor_Deployment_Guide/image27.png)
3.  
...
| - | Provide timer value in seconds to schedule the extractor: &gt; ![Screenshot showing timer_value : 0](./media/IAI_Hexagon_Extractor_Deployment_Guide/image31.png)
|  |
...
| idp-authentication. tenant | Use the tenant Id for CDF added in the Azure DevOps library in earlier steps &gt; ![Screenshot showing the parameters specified to connect to Cognite server](./media/IAI_Hexagon_Extractor_Deployment_Guide/image32.png)
|  |
...
| destination.table | Use the table name where asset hierarchy data will be uploaded and added in the Azure DevOps library in earlier steps &gt; ![Screenshot showing the Hexagon SDx system related configurations](./media/IAI_Hexagon_Extractor_Deployment_Guide/image33.png)
|  |
...
> ![Screenshot showing option to Run pipeline and see its status ](./media/IAI_Hexagon_Extractor_Deployment_Guide/image38.png)
...
> ![screenshot showing path of a log file to store extractor logs.](./media/IAI_Hexagon_Extractor_Deployment_Guide/image47.png)
B.  Add timer value in seconds to schedule the extractor.

> ![Screenshot showing timer value in seconds to schedule the extractor.](./media/IAI_Hexagon_Extractor_Deployment_Guide/image48.png)
...
| destination.table | Provide the table name where asset hierarchy data will be uploaded. &gt; ![Screenshot showing the added Hexagon SDx system related configuration parameters](./media/IAI_Hexagon_Extractor_Deployment_Guide/image49.png)
|  |
...
| D. | pythonXX.dll |
| E. | pythoncomXX.dll |
| F. | pywintypesXX.dll ![Screenshot showing the files copied to respective location.](./media/IAI_Hexagon_Extractor_Deployment_Guide/image50.png)
|  |
