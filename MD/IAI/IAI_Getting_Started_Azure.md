---
sidebar_position: 2
title: IAI Getting Started Azure
---

## Getting Started with IAI on Azure
...
| Step | Activity |
| --- | --- |
| 1 | Project Kick Off (Non-IAI) |
| 2 | Spin up Azure Client subscription with Groups, Roles and Service principles (Non-IAI) |
...
| 4 | [DevOps to deploy all IAI components](https://ts.accenture.com/:b:/r/sites/GlobalDocTemplates/Published%20Documents/AOT/AOT%202.4/AOT_Azure_Deployment_Guide_2_4.pdf) |
...
Because IAI includes People Management capabilities, it is necessary to integrate Azure Active Directory (AD) with Groups and Roles. This integration is generally performed by an Admin.
