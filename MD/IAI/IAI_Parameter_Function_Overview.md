---
sidebar_position: 2
title: IAI Parameter Function Overview
hide_title: true
---

<div class="doc-title-block">
<p class="doc-asset-name">Industrial AI Foundation</p>
<p class="doc-topic">Parameter Function App</p>
...
| **Field** | **Value** |
| --- | --- |
| **Asset / Solution Name** | Industrial AI Foundation / Parameter Function App |
...
IAI\'s Parameter Azure Function App is designed to process time telemetry data, interact with Azure Digital Twins (ADT), and maintain a synchronized state within ADT based on incoming events. It features capabilities to create, update, and manage digital twins and their relationships.
...
| **Term** | **Definition** |
| --- | --- |
| IAI (Industrial AI Foundation) | A collection of software accelerators and tools that integrate product, process, and live data from IT and OT systems to create a contextualized view of operations for better decision-making. |
...
![Parameter function architecture flow diagram showing data from Simulator to Azure IoT Hub, then Azure Stream Analytics, Azure Function, and Caching Mechanism, with outputs to Azure Digital Twins.](./media/IAI_Parameter_Function_Overview/image2.png)
...
![Azure Digital Twins Explorer showing a query result for model 'dtmi:com:aot:Parameters;2'. The interface includes a twin graph with multiple nodes and a properties panel displaying details like ADXDatabaseName, ADXTable, ClusterURI, and metadata fields.](./media/IAI_Parameter_Function_Overview/image3.png)
...
| WEBSITE_RUN_FROM_PACKAGE | Indicates if the function app is running directly from a deployment package. This can point to a URL containing a .zip file with the app\'s content or set to \"1\" to run from a package in the current storage account. ![Azure portal showing Function App environment variables for 'func-aot-parameter-metadata-dev'. The screen lists variable names like ADXDatabaseName, ADXTable, APPINSIGHTS_INSTRUMENTATIONKEY, AZURE_CLIENT_ID, AZURE_CLIENT_SECRET, and others with masked values.](./media/IAI_Parameter_Function_Overview/image4.png)
|  |
