...
| > AOT (Accenture Operations Twin) | > A collection of software accelerators and tools, including Intelligent Advisor, assembled to deliver client solutions. Accelerates integration of product, process, and live data from disparate IT and OT systems for better decisions and optimized processes. |
...
| > Insight Factory | > The library of Insight categories -- contains the definition (structure) of all Insight categories that can be configured in AOT. |
...
| > Intelligent Advisor (IA) | > AI-based AOT component that enables users to focus on critical issues with real-time generated, prioritized, and contextualized Insights and recommendations. |
...
> ![AOT configuration](media/image3.png)\{width="3.7225503062117236in" height="2.2257753718285214in"\}
...
| **CI/CD Pipeline** | - Pipeline name: *AOT-IA-Funct-APIM-MW* |
|  | - Pipeline [folder](https://digitalplantproject.visualstudio.com/Marilyn%20V/_build?treeState=XEFPVCBBcHBzIEJ1aWxkIFRlYW0gMiRcQU9UIEFwcHMgQnVpbGQgVGVhbSAyXE1pZGRsZXdhcmVBUEkkXEFPVCBBcHBzIEJ1aWxkIFRlYW0gMlxNaWRkbGV3YXJlQVBJXEJhY2tlbmQ%3D&view=folders) |
|  | - Pipeline Dev,Test,Prod [link](https://digitalplantproject.visualstudio.com/Marilyn%20V/_build?treeState=XEFPVCBBcHBzIEJ1aWxkIFRlYW0gMiRcQU9UIEFwcHMgQnVpbGQgVGVhbSAyXE1pZGRsZXdhcmVBUEkkXEFPVCBBcHBzIEJ1aWxkIFRlYW0gMlxNaWRkbGV3YXJlQVBJXEJhY2tlbmQ%3D&view=folders) |
...
| **Sample Function Code** | Function code is written in Python and contains the logic for creating the asset hierarchy. See [example](https://ts.accenture.com/:u:/r/sites/GlobalDocTemplates/Published%20Documents/AOT/Linked%20Files/handler.py). |
...
![Flow diagram for leveraging azure and CDF to generate insights](media/image4.png)\{width="9.569767060367454in" height="5.556235783027121in"\}
...
![Diagram that depicts the Generic Scheduler and CRUD operations (Create, Read, Update, Delete) performed on tasks.](media/image5.png)\{width="13.59548009623797in" height="5.11469706911636in"\}
...
| Storage Resources | This component contains two main parts: |
...
![IA config db structure](media/image6.png)\{width="6.257956036745407in" height="3.616279527559055in"\}
...
> ![Table structure](media/image7.png)\{width="3.4776224846894137in" height="3.6346555118110238in"\}
...
![Insight category configurations](media/image8.png)\{width="8.063180227471566in" height="3.2555096237970256in"\}

#### InsightCategoryConfigurationsParameters

InsightCategoryConfigurationsParameters have dedicated fields for both KPI and Predictive configurations.

[KPI configurations]\{.underline\}
...
[Predictive failure configurations]\{.underline\}
...
> ![Insight category configurations parameters](media/image9.png)\{width="8.10988845144357in" height="4.2475546806649165in"\}
...
![DB structure in azure](media/image10.png)\{width="3.200948162729659in" height="3.464315398075241in"\}


| **Table** | **Description** |
| --- | --- |
| scheduled_tasks | This table stores information about the active scheduled tasks. The string type parameters include: |
|  | - creation_date |
|  | - mod_date |
|  | - Name |
|  | - parameters |
...
![ML database model structure](media/image11.png)\{width="2.5833333333333335in" height="2.9583333333333335in"\}
...
| Component | Description |
| --- | --- |
| Scheduler | A task scheduler is implemented utilizing the existing generic scheduler API, configured to operate at hourly intervals. This scheduler orchestrates the periodic execution of subsequent tasks within the middleware microservice environment. |
|  | For more information on the Generic Scheduler, refer to the [Generic Scheduler Technical Overview](https://industryxdevhub.accenture.com/assetdetails/83). |
...
![Flow diagram for UC1 -- Predicting Control Valve Failure](media/image12.png)\{width="8.008182414698163in" height="4.194349300087489in"\}
...
![Flow diagram for UC2 -- Smart KPI for OEE](media/image13.png)\{width="7.902279090113736in" height="4.315972222222222in"\}
...
![AOT Insight template hierarchy diagram](media/image14.png)\{width="6.822916666666667in" height="3.368640638670166in"\}

The screenshot below shows the IA configuration of the insight category and insight template hierarchy.

![IA configuration of insight category](media/image15.png)\{width="7.125in" height="3.2381944444444444in"\}

The template is used by UI, and it has details about insights.

![Template used by UI that has details about insights](media/image16.png)\{width="6.365786307961505in" height="3.468122265966754in"\}
