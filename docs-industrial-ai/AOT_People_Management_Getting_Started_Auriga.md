...
| 4 | If AD group is complete and updated, then admin can manually run sync services to update the database and skip to step 11. [LINK](https://ts.accenture.com/sites/GlobalDocTemplates/Published%20Documents/AOT/AOT%202.4/AOT_People_Management_UI_Guide_2_4.pdf) |
|  | If AD group is incomplete and needs update, then admin must follow the remaining steps. |
...
| [AOT Azure People Management Integration with Smart KPIs](https://ts.accenture.com/sites/GlobalDocTemplates/Published%20Documents/AOT/AOT%202.4/AOT_Azure_People_Management_Integration_with_SmartKPIs_2_4.pdf) |  | Permission Types - 3 | Adding Roles to Timeseries - 17 |
|  |  | Functional Permissions - 4 | Result - 18 |
|  |  | Data Permissions - 5 |  |
|  |  | Main Layers - 6 |  |
