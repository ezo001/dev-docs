...
-   [[AOT Documents]\{.underline\}](https://industryxdevhub.accenture.com/asset-home;search_text=AOT)

-   [[Release Notes]\{.underline\}](https://industryxdevhub.accenture.com/assetdetails/45)

-   [[AOT Twin Builder and Twin Viewer Architecture Blueprint]\{.underline\}](https://industryxdevhub.accenture.com/assetdetails/47)

-   [[AOT_People Management_Context Diagram]\{.underline\}](https://ts.accenture.com/:u:/r/sites/GlobalDocTemplates/Published%20Documents/AOT/Linked%20Files/AOT_People%20Management_Context.svg?csf=1&web=1&e=jiA5Ip)

-   [[AOT People Management Architecture Blueprint]\{.underline\}](https://industryxdevhub.accenture.com/assetdetails/64)
...
![Diagram showing the AOT system architecture: external data sources feed into ETL, contextualization, and knowledge graph layers. Applications, analytics, and people management modules sit atop, with stream analytics integrated throughout.](media/image2.png)\{width="8.753094925634295in" height="7.43283573928259in"\}
...
![Flowchart illustrating how external data sources are processed into a knowledge graph, which then powers applications. Stream analytics are shown as a parallel process.](media/image4.svg)\{width="4.08955271216098in" height="1.6424573490813648in"\}
...
![System landscape diagram mapping AOT modules (Configurator, Operator, Platform Tools, Visualizer, Reporting, Operations Hierarchy, etc.) and their integration points within a customer ecosystem.](media/image6.svg)\{width="13.823152887139107in" height="6.988371609798775in"\}
...
![Architecture diagram showing how AOT leverages Azure services: data flows from sources through IoT Hub, Data Factory, and stream analytics into knowledge graph components (ADX, ADT, ADLS, SQL DB), with microservices and applications layered above.](media/image8.svg)\{width="9.623260061242345in" height="6.697674978127734in"\}
...
![Diagram depicting DataOps at the center, ingesting data from source systems and providing it to Smart KPIs, Intelligent Advisor, and Operations Hierarchy modules.](media/image10.svg)\{width="6.8953488626421695in" height="5.612926509186352in"\}\
Dependencies
...
![Container diagram showing DataOps components (Knowledge Graph, Data Lake, Relational Data, Stream Analytics, Data Factory) and their connections to source systems and consuming modules.](media/image12.svg)\{width="7.930232939632546in" height="8.049847987751532in"\}
...
![Deployment diagram mapping where DataOps components are hosted (Azure, AKS Cluster, Edge/On Premise), with lines of communication between services and databases.](media/image14.svg)\{width="5.546511373578303in" height="8.119597550306212in"\}
...
![Container diagram illustrating the Scheduler microservice, its configuration database, and event consumer, showing how scheduled jobs are triggered and logged.](media/image16.svg)\{width="4.963393482064742in" height="5.929861111111111in"\}
...
![Diagram showing integration of data analytics models: model handlers, microservices, APIs, and connections to knowledge graph and machine learning environments.](media/image18.svg)\{width="8.891181102362205in" height="8.020833333333334in"\}
...
![](media/image19.png)\{width="13.251513560804899in" height="6.479166666666667in"\}
...
![Flowchart of ML model training, validation, deployment, and monitoring, with feedback loop for retraining based on performance data.](media/image21.svg)\{width="3.09375in" height="4.022606080489939in"\}
...
![Diagram showing ML model deployment options: in-memory within microservices, on AKS, or on edge devices, with event-driven execution and result reporting.](media/image23.svg)\{width="5.837089895013123in" height="4.427083333333333in"\}
...
![Diagram mapping localization configurator, microservices, configuration database, and UI modules (Reporting, Operations Hierarchy, Advisor, People Management, Smart KPIs, 3D Visualizer), showing language selection and translation flow.](media/image25.svg)\{width="7.694852362204724in" height="8.125in"\}

### Deployment

![Deployment diagram showing localization components hosted on Azure, AKS Cluster, and customer computers, with connections to databases and microservices.](media/image27.svg)\{width="14.0in" height="3.995138888888889in"\}
...
![Diagram showing People Management at the center, managing roles and access for users and groups, with connections to Smart KPIs, Intelligent Advisor, 3D Visualizer, Operations Hierarchy, and Reporting modules.](media/image29.svg)\{width="13.15625in" height="5.703852799650043in"\}
...
![Container diagram detailing People Management application, microservices, notification service, database, and integration with Azure Active Directory.](media/image31.svg)\{width="6.360464785651794in" height="7.016896325459317in"\}
...
![Deployment diagram showing hosting locations for People Management components, without communication lines.](media/image33.svg)\{width="4.75in" height="7.688288495188101in"\}\
[Diagram showing communication connections]\{.underline\}

![Deployment diagram showing hosting locations and communication connections between People Management components, databases, and Azure AD.](media/image35.svg)\{width="4.187462817147857in" height="7.489583333333333in"\}
...
![Diagram mapping Intelligent Advisor's integration with DataOps, Smart KPIs, People Management, Operations Hierarchy, Reporting, 3D Visualizer, and MLOps.](media/image37.svg)\{width="8.10465113735783in" height="6.1396402012248465in"\}
...
![Entity-relationship diagram showing Insight Category, Asset, Insight, Action, and their relationships for configuration and operational models.](media/image38.png)\{width="6.456960848643919in" height="8.081395450568678in"\}
...
![Container diagram showing IA components (Insight generation, collaboration, actions, advisor panel, details, lifecycle management), shared platform tools, and module integrations.](media/image40.svg)\{width="4.0in" height="8.144872047244094in"\}
...
![Flowchart showing how IA configuration, scheduler, data analytics, and ML models interact to generate insights and actions.](media/image42.svg)\{width="4.651162510936133in" height="8.078137576552932in"\}
...
![Deployment diagram mapping hosting and communication connections for IA system components.](media/image44.svg)\{width="7.744186351706037in" height="8.189821741032372in"\}
...
![](media/image46.svg)\{width="6.885416666666667in" height="5.1061089238845145in"\} ![](media/image48.svg)\{width="6.176325459317585in" height="5.256711504811898in"\}

![](media/image50.svg)\{width="6.876441382327209in" height="3.1039938757655294in"\}
...
![](media/image52.svg)\{width="6.771535433070866in" height="5.405900043744532in"\}
...
![](media/image54.svg)\{width="4.302083333333333in" height="6.5in"\}
...
![Diagram showing Smart KPIs integration with DataOps, Operations Hierarchy, People Management, Intelligent Advisor, 3D Visualizer, and Reporting.](media/image56.svg)\{width="9.44617782152231in" height="5.860464785651794in"\}
...
![Configuration domain model for Smart KPIs, showing KPI definition variables.](media/image58.svg)\{width="4.545833333333333in" height="3.855444006999125in"\}

![Entity-relationship diagram showing KPI Definition, KPI Instance, Parameters, Numeric Timeseries, and Asset relationships for configuration and operation.](media/image60.svg)\{width="8.255722878390202in" height="4.372093175853018in"\}
...
![Combined configuration and operational domain model for Smart KPIs, showing relationships between definitions, instances, and assets.](media/image62.svg)\{width="7.625in" height="7.937851049868766in"\}
...
> ![Container diagram showing Smart KPIs components, platform tools, and knowledge graph integration.](media/image64.svg)\{width="4.982629046369204in" height="6.406938976377953in"\}
...
![Flowchart showing how scheduler, calculation functions, orchestrator, and event notifications interact for KPI calculations.](media/image66.svg)\{width="5.979166666666667in" height="8.883155074365705in"\}
...
![Deployment diagram mapping hosting and communication for Smart KPIs system components.](media/image68.svg)\{width="8.267549212598425in" height="9.020833333333334in"\}
...
![Diagram showing Operations Hierarchy as backbone of knowledge graph, with connections to other business applications.](media/image70.svg)\{width="10.474712379702536in" height="5.510416666666667in"\}

**Domain Model**

The OH domain model only consists of the Asset object.

![Simple entity diagram showing Asset object as the core of Operations Hierarchy.](media/image72.svg)\{width="2.841666666666667in" height="1.9083333333333334in"\}

## 

## Containers

![Container diagram showing Operations Hierarchy applications, microservices, and data storage.](media/image74.svg)\{width="6.8125in" height="9.345351049868766in"\}
...
![Deployment diagram mapping hosting and communication for Operations Hierarchy components.](media/image76.svg)\{width="8.333333333333334in" height="9.004629265091863in"\}

# 

# Production Manager

Production Manager is the sub-system that is responsible for Managing Production Processes and Data. Its primary scope should be the Production Domain from the ISA-95 standard.![](media/image78.svg)\{width="10.4375in" height="5.791362642169728in"\}
...
![](media/image80.svg)\{width="4.8961034558180225in" height="9.740260279965005in"\}

**Containers**

![](media/image82.svg)\{width="6.8125in" height="6.645979877515311in"\}
...
![](media/image84.svg)\{width="3.6924846894138232in" height="9.004166666666666in"\}
...
![Diagram showing 3D Visualizer and Builder applications, their integration with knowledge graph, KPIs, insights, and asset hierarchy.](media/image86.svg)\{width="7.833333333333333in" height="5.903187882764654in"\}
...
The following container diagram describes the individual components of the system, with the most relevant connections highlighted.![Container diagram showing 3D visualization components, platform tools, and module integrations.](media/image88.svg)\{width="11.385416666666666in" height="7.618851706036746in"\}

## Deployment diagrams

![Container diagram showing 3D module components, platform tools, and data flows for contextualized visualization.](media/image90.svg)\{width="5.0374201662292215in" height="8.668830927384077in"\}

![Deployment diagrams mapping hosting and communication for 3D visualization components.](media/image92.svg)\{width="4.773611111111111in" height="9.0in"\}
...
![Diagram showing reporting modules reading data from knowledge graph, Operations Hierarchy, Smart KPIs, Intelligent Advisor, and People Management for permissions.](media/image94.svg)\{width="7.772804024496938in" height="4.40625in"\}
...
![Container diagram showing reporting application, configuration application, microservices, and databases.](media/image96.svg)\{width="9.074241032370953in" height="5.996172353455818in"\}

## 

## Deployment diagrams

![Deployment diagrams mapping hosting and communication for reporting system components.](media/image98.svg)\{width="5.8088112423447065in" height="9.0625in"\}

![Deployment diagrams mapping hosting and communication for reporting system components.](media/image100.svg)\{width="4.634613954505687in" height="9.100694444444445in"\}
...
![Diagram showing AOT application landscape, dividing business and configuration apps, with embedded micro-frontends and stand-alone configuration apps.](media/image102.svg)\{width="14.0in" height="7.875in"\}
...
|  | 2. Data permissions defined to data points inside the knowledge graph (asset hierarchy, KPIs, Insights, etc.) that are based on roles and responsibilities. The users have access only to the data to which their permissions are mapped. |
