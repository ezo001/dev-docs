...
![Parameter function architecture flow diagram showing data from Simulator to Azure IoT Hub, then Azure Stream Analytics, Azure Function, and Caching Mechanism, with outputs to Azure Digital Twins.](media/image2.png)\{width="7.272716535433071in" height="3.6603740157480313in"\}
...
![Azure Digital Twins Explorer showing a query result for model 'dtmi:com:aot:Parameters;2'. The interface includes a twin graph with multiple nodes and a properties panel displaying details like ADXDatabaseName, ADXTable, ClusterURI, and metadata fields.](media/image3.png)\{width="9.767122703412074in" height="5.1617771216097985in"\}
...
![Azure portal showing Function App environment variables for 'func-aot-parameter-metadata-dev'. The screen lists variable names like ADXDatabaseName, ADXTable, APPINSIGHTS_INSTRUMENTATIONKEY, AZURE_CLIENT_ID, AZURE_CLIENT_SECRET, and others with masked values.](media/image4.png)\{width="5.917431102362205in" height="7.188693132108487in"\}
