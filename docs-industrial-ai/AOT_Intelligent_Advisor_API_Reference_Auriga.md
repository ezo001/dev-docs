...
[Introduction [3](#_Toc115182691)](#_Toc115182691)
...
| > **Term** | > **Definition** |
| --- | --- |
| > AOT (Accenture Operations Twin) | > A suite of software accelerators and tools integrating product, process, and live data from IT and OT systems, providing a comprehensive view of operations for better decision-making and process optimization. |
| > IA (Intelligent Advisor) | > An AI-based AOT component generating real-time, prioritized, and contextualized insights and recommendations, with modules for insight generation, collaboration, actions, advisor panel, and lifecycle management. |
...
| > Configuration APIs | > APIs for creating, updating, or deleting configuration settings for models and insights within the AOT platform. |
| > Entity Viewer | > A micro front end application within AOT for visualizing 360-degree information related to nodes in the asset hierarchy. |
...
| Update configuration | This API updates the model_configuration and dedicated_model_configuration tables based on the configuration ID in Azure DB. |
