...
[Target Audience [3](#OLE_LINK1)](#OLE_LINK1)
...
![Create Variable group tab](media/image2.png)\{width="5.747575459317585in" height="3.6097156605424323in"\}

4.  Update the pipeline file with the relevant library name.

> ![Contents tab showing variables](media/image3.png)\{width="10.625in" height="4.278244750656168in"\}
...
>
> ![screenshot of pm_insert_data_system_roles.sql](media/image4.png)\{width="11.100043744531934in" height="5.025786307961504in"\}
...
> ![AWS Console](media/image5.png)\{width="13.047312992125985in" height="4.9375in"\}
...
> ![Variable group tab](media/image6.png)\{width="6.902777777777778in" height="3.846227034120735in"\}

-   Update the pipeline file with the relevant library name.

> ![Pipeline file with variables and library name](media/image7.png)\{width="8.715575240594926in" height="4.84410542432196in"\}
...
> ![Azure portal showing set of APIs and policies](media/image8.png)\{width="9.83397309711286in" height="4.9328991688538935in"\}
