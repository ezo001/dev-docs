...
![](media/image2.png)\{width="0.6902777777777778in" height="0.7166666666666667in"\}
...
>
> ![](media/image3.png)\{width="6.631591207349081in" height="3.59375in"\}\
> Method two is to launch the application from the overview page.
>
> ![](media/image4.png)\{width="6.809815179352581in" height="3.7694750656167977in"\}
...
![DT_3D_POI_Editor](media/image6.jpeg)\{width="6.5in" height="3.5638068678915134in"\}
...
![DT_3D_Model_Mapping](media/image7.jpeg)\{width="6.5in" height="3.5631944444444446in"\}

The video below shows how to add new asset mapping.

![Add_Model_Mapping](media/image8.jpeg)\{width="6.578071959755031in" height="3.581395450568679in"\}
...
![Delete Model Mapping](media/image9.jpeg)\{width="6.418604549431321in" height="3.4767443132108484in"\}
...
![Edit Mapping](media/image10.jpeg)\{width="6.449931102362204in" height="3.5116283902012246in"\}
...
> ![DT_3D_POI_Mapping](media/image11.gif)\{width="6.5in" height="3.563804680664917in"\}
...
![](media/image12.png)\{width="2.6069444444444443in" height="4.1618055555555555in"\}
...
![](media/image13.png)\{width="7.459549431321085in" height="3.940475721784777in"\}

![](media/image14.png)\{width="7.523009623797026in" height="3.9253390201224847in"\}
...
> ![2D Twin option in side menu](media/image15.png)\{width="3.5625in" height="4.966666666666667in"\}
...
> ![](media/image16.png)\{width="8.238636264216973in" height="4.893055555555556in"\}
...
![error message when no files are available](media/image17.png)\{width="3.5149114173228346in" height="1.8452384076990376in"\}
...
![A screenshot of a computer AI-generated content may be incorrect.](media/image18.png)\{width="10.207573272090988in" height="5.4080894575678045in"\}
...
![2D Schematics Configurator Demo ](media/image19.gif)\{width="6.53125in" height="3.0120811461067367in"\}
...
![A screenshot of a computer AI-generated content may be incorrect.](media/image20.png)\{width="4.58176290463692in" height="2.5170319335083113in"\}

![](media/image21.png)\{width="11.05233486439195in" height="5.845238407699037in"\}
