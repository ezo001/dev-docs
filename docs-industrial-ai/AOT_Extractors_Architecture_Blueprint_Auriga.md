---
sidebar_position: 2
title: AOT Extractors Architecture Blueprint Auriga
---
...
**Metadata Table**
  ...
  **Related Assets / Alternatives**   AOT Extractors Getting Started
  -----------------------------------------------------------------------------------------------------------------

![](media/image2.png)\{width="0.8055555555555556in" height="0.8347222222222223in"\}
...
[SAP PM Extractor [5](#sap-pm-extractor)](#sap-pm-extractor)

[PI AF Extractor [6](#pi-af-extractor)](#pi-af-extractor)

[Hexagon Extractor [7](#hexagon-extractor)](#hexagon-extractor)

[Flat File Extractors [8](#flat-file-extractors)](#flat-file-extractors)

[Availability Matrix [9](#availability-matrix)](#availability-matrix)
...
![Diagram for SAP-CDF Data Integration Architecture](media/image3.png)\{width="11.15625in" height="4.223034776902887in"\}
...
In this extractor, [OSI\'s](https://docs.osisoft.com/bundle/pi-server/page/pi-asset-framework-and-pi-system-explorer.html) PI batch request APIs are used to get user-provided details about the root asset. AOT extractors extract the PI AF data, transform it into data that CDF can consume, and then push the data to CDF RAW tables. The extractor is based on Python and Cognite Extractor Utilities and is typically hosted on Azure Services. Its extraction pipeline functionality notifies specified users of successful and failed pipeline runs on CDF UI.

![Diagram for PI AF Extractor Architecture](media/image4.png)\{width="12.031498250218723in" height="4.21875in"\}
...
![Diagram for Hexagon Extractor Architecture](media/image5.png)\{width="11.572916666666666in" height="3.791540901137358in"\}
...
![Diagram for Flat File Extractor Architecture](media/image6.png)\{width="11.987844488188976in" height="4.145833333333333in"\}
...
The table below summarizes the AOT Data Integration Accelerators that are currently available for both source systems and flat files.
