...
[POST-Download File [6](#section-5)](#section-5)
...
## Specification
  ...
  Protocol                              HTTPS
  ------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------
  PATH AOT (Cognite)(Public Exposure)   [[https://apim-mw-aot-dev.azure-api.net/api/filehandler/files/upload]\{.underline\}](https://apim-mw-aot-dev.azure-api.net/api/filehandler/files/upload)

  PATH AOT (Azure)(Public Exposure)     [[https://apim-aot-azure-dev.azure-api.net/api/filehandler/files/upload]\{.underline\}](https://apim-aot-azure-dev.azure-api.net/api/filehandler/files/upload)
