...
> ![Screenshot showing how the pipeline file can be updated with the library name](media/image2.png)\{width="6.444444444444445in" height="2.614220253718285in"\}
...
![Folder structure in OH Module APIs showing the pipeline lines](media/image3.png)\{width="3.2083333333333335in" height="4.797169728783902in"\} ![Folder structure in OH Config APIs showing the pipeline lines](media/image4.png)\{width="2.9328685476815397in" height="4.800694444444445in"\}
...
> ![validate correct set of APIs for Module middleware](media/image5.png)\{width="6.301528871391076in" height="2.8069936570428697in"\}
>
> ![Screenshot of ADO APIM showing the APIs that were created](media/image6.png)\{width="6.311070647419073in" height="2.854534120734908in"\}
