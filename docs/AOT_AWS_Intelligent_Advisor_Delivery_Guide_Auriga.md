---
id: aot-aws-intelligent-advisor-delivery-guide-auriga
...
This API inserts the configurations as configured from UI into to model_configuration and dedicated_model_configuration table in the AWS RDS.
``
``
Update configuration
`This API updates the model_configuration and dedicated_model_configuration tables based on the configuration ID in AWS RDS.`
...
This API deletes the configuration from model_configuration and dedicated_model_configuration tables based on the configuration ID in AWS RDS.
``
``
``
