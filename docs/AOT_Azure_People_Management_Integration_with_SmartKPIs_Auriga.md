---
id: aot-azure-people-management-integration-with-smartkpis-auriga
title: AOT Azure People Management Integration with SmartKPIs Auriga
---

`\>` AOT on Azure
`\>`
`\>` People Management Integration with Smart KPIs
`\>`
`\>` Release Version: 2.5
...
[Metadata of People Management [14](#metadata-of-people-management)](#metadata-of-people-management)
...
[Use Case 4: POST- RAG API [17](#use-case-4-post--rag-api)](#use-case-4-post--rag-api)
...
| **PROTOCOL** |  HTTP |
|:---|:---|
| **PATH `\<`Public Exposure`\>`** | `\<`https://apim-aot-azure-dev.azure-api.net/api/people-management/roles/byIds?ids=`\>` |
| **METHOD** |  POST |
| **CONTENT TYPE** | application / json |
| **Request URL** |  |
