---
id: aot-operations-hierarchy-getting-started-auriga
...
Merge/standardize asset hierarchies and identify conflicts

AH in Source System(s)
...
Data extractors pull data from source systems

Assignment of OH levels to roles

Entity viewer template definition by level

Conflict resolution and operations hierarchy approval

**Client/ACN Consultant**

Entity viewer generation based on selection of asset hierarchical levels of plant and multi-plant

Operations Hierarchy creation
...
``
AOT Operations Hierarchy API Reference
This reference document includes information about the Operations Hierarchy structure present in Cognite Data Fusion. Additionally, the document includes descriptions of the APIs that facilitate configuration and middleware functions.
`OH Module APIs – 4`
OH Config APIs – 24
Entity Viewer Config APIs - 30
``
``
AOT Operations Hierarchy UI Guide
This document explains how to use the Operation Hierarchy component of the AOT UI. After reading this document, the user should understand how to launch the UI and perform various actions related to the hierarchy of assets.
`Launch the Application – 4`
OH Interface – 6
...
``
``
`AOT Cognite Operations Hierarchy Backend Deployment Guide`
AOT Azure Operations Hierarchy Deployment Guide
`This guide describes the deployment of the Operations Hierarchy Module APIs including:`

Infrastructure as Code Microservice (IaC MS)
