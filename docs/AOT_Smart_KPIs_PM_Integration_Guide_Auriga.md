---
id: aot-smart-kpis-pm-integration-guide-auriga
...
- This guide describes how the needed to integrate the people management component with other AOT components, and describes PM and Smart KPI integration as an example.
...
| PROTOCOL | HTTP |
|----|----|
| PATH `\<`Public Exposure`\>` | `\<`https://apim-mw-aot-dev.azure-api.net/api/people-management/roles/byIds?ids=`\>` |
