---
id: aot-release-notes-auriga
title: AOT Release Notes Auriga
---
...
- A new Expert Knowledge module uses IX GenAI’s Knowledge Validation Agent and AOT’s Recommendation Framework to enhance the capture and validation of expert knowledge used for generation of actionable recommendations.

- Light mode readability has been improved across all AOT components.
...
In addition to the above application-based improvements, AOT’s development team delivered expanded [architectural blueprints](https://ts.accenture.com/:f:/r/sites/IX-AccentureOperationsTwin/Shared%20Documents/General/8.%20Architecture/Blueprints?csf=1&web=1&e=eQKBIB) and documented industry-specific use cases – spanning across semiconductor, pharma, automotive, oil and gas, CPG, specialty chemicals, and energy consumption optimization (ECO) – that demonstrate AOT’s versatility in addressing real-world manufacturing challenges.

# New Features and Enhancements

## Batch Analysis Module

AOT’s new Batch Analysis module has been introduced for discrete and batch manufacturing industries. It enables users to trace production orders and product genealogy across production and consumption processes. This new module is overlaid with AOT’s existing components (Operations Hierarchy, Smart KPIs, Twin Builder, and Twin Viewer) to provide the following functionalities:
...
- 3D builder UX has been aligned with the latest AOT design system to ensure uniformity and standardization.
...
The Engineering Workbench (EWB) integration from the 2.4 release has been enhanced and now consumes data from AOT graph directly. As a result:

- AOT users can navigate to EWB to create, host, configure, and fine tune ML models on EWB, based on the data in ADT and ADX sources

- AOT users can operationalize ML models on AOT and utilize the outcomes to configure insight on Intelligent Advisor.
