---
id: aot-reports-delivery-guide-auriga
...
``
Request URL
https://apim-aot-mw-dev.azure-api.net/api/powerbi/powerbi/groupId/82e09c53-370d-41ec-8519-ed4561b2bbe2/reportId/b72191d5-7ac8-4e44-adf4-cd334216644a
``
``
...
``\{
PowerbiEmbedToken:[`\{`
EmbedToken:” H4sIAAAAAAAEAB2Wxw6sSBJF_-VtGQmKw”,
