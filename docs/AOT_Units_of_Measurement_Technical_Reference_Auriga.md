---
id: aot-units-of-measurement-technical-reference-auriga
...
``
API for fetching the list of units based on unit system and unit type.
``
``
``
GET- GetUnitSystems
``
API for fetching the list of all the unit systems in AOT.
``
``
``
GET- GetUoMConversions
``
API for fetching the list of all unit conversions.
``
``
``
GET- GetUoM
``
API for fetching the unit of measurement details.
``
``
``
GET- GetUoMByUnitSystemId
``
API for fetching the list of UoM by using unit system ID.
``
``
``
GET- GetUoMEquivalents
``
API for fetching a list of UoM Equivalents in other unit systems of a particular UoM by using source UoM ID, source Unit System ID, Destination UoM ID, and Destination Unit System ID.
``
``
``
...
| PATH AOT (Azure) https://apim-aot-azure-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit/byunitsystemandtype?unitSystemId=`&#123;unitSystemId&#125;`&unitType=`&#123;unitType&#125;` |
| METHOD | GET |
...
&gt; `&#123;` "message": "Error occurred while retrieving unit of measurements", "error": "Given UnitSystem Id [&lt;’an invalid unit system id’&gt;] is not a valid UUID, Please provide a valid UnitSystemId to process." `&#125;`
...
| PROTOCOL | HTTPS |
|----|----|
| PATH AOT (Cognite) [https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit?QueryString=`&#123;QueryString&#125;`](https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit?QueryString=%7bQueryString%7d) |
| PATH AOT (Azure) https://apim-aot-azure-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit?QueryString=`&#123;QueryString&#125;`](https://apim-aot-azure-dev.azure-api.net/api/unit-of-measurement/metadata/measurementUnit?QueryString=%7bQueryString%7d) |
| METHOD | GET |
| CONTENT TYPE | application / json |
...
``
PATH AOT (Cognite) &lt;Public Exposure&gt;&lt;/h3&gt;
https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/measurementUnits/byUnitSystemId/`&#123;unitSystemId&#125;` &lt;/h3&gt;
``
``
PATH AOT (Azure) &lt;Public Exposure&gt;&lt;/h3&gt;
https://apim-aot-azure-dev.azure-api.net/api/unit-of-measurement/measurementUnits/byUnitSystemId/`&#123;unitSystemId&#125;` &lt;/h3&gt;
``
``
METHOD&lt;/h3&gt;
GET&lt;/h3&gt;
...
``
PATH AOT (Cognite) &lt;Public Exposure&gt;&lt;/h3&gt;
https://apim-mw-aot-dev.azure-api.net/api/unit-of-measurement/UoMEquivalents &lt;/h3&gt;
``
``
PATH AOT (Azure) &lt;Public Exposure&gt;&lt;/h3&gt;
https://apim-aot-azure-dev.azure-api.net/api/unit-of-measurement/UoMEquivalents &lt;/h3&gt;
``
``
METHOD&lt;/h3&gt;
GET&lt;/h3&gt;
