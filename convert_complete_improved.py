...
This version ESCAPES curly braces instead of removing them
"""
        ...
        if not in_code_block:
            ...
            for i in range(len(parts)):
                if i % 2 == 0:  # Outside inline code
                    # Escape curly braces instead of removing them
...
def main():
    ...
    if success_count == len(docx_files):
        ...
        print("\nNext steps:")
        print("  1. Update docusaurus.config.js (for .emf images)")
